...
var e = Object.create, t = Object.defineProperty, n = Object.getOwnPropertyDescriptor, r = Object.getOwnPropertyNames, i = Object.getPrototypeOf, a = Object.prototype.hasOwnProperty, o = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), s = (e, i, o, s) => {
	...
	(function() {
		var n, r = "Expected a function", i = "__lodash_hash_undefined__", a = "__lodash_placeholder__", o = 1, s = 2, c = 8, l = 16, u = 32, d = 64, f = 128, p = 256, m = 512, h = Infinity, g = 9007199254740991, _ = NaN, v = 4294967295, y = v - 1, b = v >>> 1, x = [
			...
			Dt,
			k
		].join("|") + ")", zt = RegExp(gt, "g"), Bt = RegExp(vt, "g"), Vt = RegExp(Ct + "(?=" + Ct + ")|" + Rt + It, "g"), Ht = RegExp([
			Ot + "?" + xt + "+" + Mt + "(?=" + [
				_t,
				Ot,
				"$"
			...
			yt,
			Lt
		].join("|"), "g"), Ut = RegExp("[" + kt + st + ct + mt + "]"), N = /[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/, Wt = /* @__PURE__ */ "Array.Buffer.DataView.Date.Error.Float32Array.Float64Array.Function.Int8Array.Int16Array.Int32Array.Map.Math.Object.Promise.RegExp.Set.String.Symbol.TypeError.Uint8Array.Uint8ClampedArray.Uint16Array.Uint32Array.WeakMap._.clearTimeout.isFinite.parseInt.setTimeout".split("."), Gt = -1, P = {};
		P[Ce] = P[C] = P[we] = P[Te] = P[Ee] = P[w] = P[De] = P[Oe] = P[ke] = !0, P[ee] = P[te] = P[xe] = P[re] = P[Se] = P[ie] = P[oe] = P[se] = P[le] = P[ue] = P[fe] = P[he] = P[S] = P[ge] = P[ye] = !1;
		var F = {};
		F[ee] = F[te] = F[xe] = F[Se] = F[re] = F[ie] = F[Ce] = F[C] = F[we] = F[Te] = F[Ee] = F[le] = F[ue] = F[fe] = F[he] = F[S] = F[ge] = F[_e] = F[w] = F[De] = F[Oe] = F[ke] = !0, F[oe] = F[se] = F[ye] = !1;
		var I = {
			À: "A",
			Á: "A",
			Â: "A",
			...
			"\u2028": "u2028",
			"\u2029": "u2029"
		}, Yt = parseFloat, Xt = parseInt, Zt = typeof global == "object" && global && global.Object === Object && global, Qt = typeof self == "object" && self && self.Object === Object && self, L = Zt || Qt || Function("return this")(), $t = typeof e == "object" && e && !e.nodeType && e, en = $t && typeof t == "object" && t && !t.nodeType && t, tn = en && en.exports === $t, nn = tn && Zt.process, R = function() {
			try {
				return en && en.require && en.require("util").types || nn && nn.binding && nn.binding("util");
			} catch {}
		}(), rn = R && R.isArrayBuffer, an = R && R.isDate, on = R && R.isMap, sn = R && R.isRegExp, cn = R && R.isSet, ln = R && R.isTypedArray;
		function un(e, t, n) {
			switch (n.length) {
		...
		function gn(e, t) {
			return !!(e != null && e.length) && Dn(e, t, 0) > -1;
		}
		function _n(e, t, n) {
		...
		function Rn(e) {
			return e && e.slice(0, or(e) + 1).replace(Ge, "");
		}
		function zn(e) {
			return function(t) {
				return e(t);
		...
		function Hn(e, t) {
			for (var n = -1, r = e.length; ++n < r && Dn(t, e[n], 0) > -1;);
			return n;
		}
		function Un(e, t) {
			for (var n = e.length; n-- && Dn(t, e[n], 0) > -1;);
			return n;
		}
		function Wn(e, t) {
		...
		function ir(e) {
			return Yn(e) ? cr(e) : Sn(e);
		}
		function ar(e) {
			return Yn(e) ? lr(e) : Cn(e);
		}
		function or(e) {
		...
		var dr = (function e(t) {
			t = t == null ? L : dr.defaults(L.Object(), t, dr.pick(L, Wt));
			var T = t.Array, Ye = t.Date, st = t.Error, ct = t.Function, lt = t.Math, D = t.Object, ut = t.RegExp, dt = t.String, O = t.TypeError, ft = T.prototype, pt = ct.prototype, mt = D.prototype, ht = t["__core-js_shared__"], gt = pt.toString, k = mt.hasOwnProperty, _t = 0, vt = function() {
				var e = /[^.]+$/.exec(ht && ht.keys && ht.keys.IE_PROTO || "");
				return e ? "Symbol(src)_1." + e : "";
			}(), yt = mt.toString, bt = gt.call(D), xt = L._, St = ut("^" + gt.call(k).replace(Ue, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), Ct = tn ? t.Buffer : n, wt = t.Symbol, Tt = t.Uint8Array, Et = Ct ? Ct.allocUnsafe : n, Dt = $n(D.getPrototypeOf, D), Ot = D.create, kt = mt.propertyIsEnumerable, At = ft.splice, jt = wt ? wt.isConcatSpreadable : n, Mt = wt ? wt.iterator : n, A = wt ? wt.toStringTag : n, Nt = function() {
				try {
					var e = Io(D, "defineProperty");
					return e({}, "", {}), e;
				} catch {}
			}(), j = t.clearTimeout !== L.clearTimeout && t.clearTimeout, Pt = Ye && Ye.now !== L.Date.now && Ye.now, M = t.setTimeout !== L.setTimeout && t.setTimeout, Ft = lt.ceil, It = lt.floor, Lt = D.getOwnPropertySymbols, Rt = Ct ? Ct.isBuffer : n, Vt = t.isFinite, Ht = ft.join, Ut = $n(D.keys, D), N = lt.max, I = lt.min, Kt = Ye.now, qt = t.parseInt, Jt = lt.random, Zt = ft.reverse, Qt = Io(t, "DataView"), $t = Io(t, "Map"), en = Io(t, "Promise"), nn = Io(t, "Set"), R = Io(t, "WeakMap"), Sn = Io(D, "create"), Cn = R && new R(), Mn = {}, nr = bs(Qt), cr = bs($t), lr = bs(en), fr = bs(nn), pr = bs(R), mr = wt ? wt.prototype : n, hr = mr ? mr.valueOf : n, gr = mr ? mr.toString : n;
			function V(e) {
				if (X(e) && !q(e) && !(e instanceof H)) {
					if (e instanceof yr) return e;
					if (k.call(e, "__wrapped__")) return Ss(e);
				}
				return new yr(e);
			}
			var _r = function() {
			...
			V.templateSettings = {
				...
				variable: "",
				imports: { _: V }
			}, V.prototype = vr.prototype, V.prototype.constructor = V, yr.prototype = _r(vr.prototype), yr.prototype.constructor = yr;
			function H(e) {
			...
			function br() {
				...
				return e.__actions__ = qa(this.__actions__), e.__dir__ = this.__dir__, e.__filtered__ = this.__filtered__, e.__iteratees__ = qa(this.__iteratees__), e.__takeCount__ = this.__takeCount__, e.__views__ = qa(this.__views__), e;
			}
			function xr() {
			...
			function Sr() {
				var e = this.__wrapped__.value(), t = this.__dir__, n = q(e), r = t < 0, i = n ? e.length : 0, a = Bo(0, i, this.__views__), o = a.start, s = a.end, c = s - o, l = r ? s : o - 1, u = this.__iteratees__, d = u.length, f = 0, p = I(c, this.__takeCount__);
				if (!n || !r && i == c && p == c) return Oa(e, this.__actions__);
				var m = [];
				outer: for (; c-- && f < p;) {
					l += t;
			...
			H.prototype = _r(vr.prototype), H.prototype.constructor = H;
			function Cr(e) {
			...
			function Dr(e) {
				var t = this.__data__;
				return Sn ? t[e] !== n : k.call(t, e);
			}
			function Or(e, t) {
				var r = this.__data__;
				return this.size += +!this.has(e), r[e] = Sn && t === n ? i : t, this;
			}
			Cr.prototype.clear = wr, Cr.prototype.delete = Tr, Cr.prototype.get = Er, Cr.prototype.has = Dr, Cr.prototype.set = Or;
			function kr(e) {
				var t = -1, n = e == null ? 0 : e.length;
				for (this.clear(); ++t < n;) {
					var r = e[t];
			...
			function jr(e) {
				...
				return n < 0 ? !1 : (n == t.length - 1 ? t.pop() : At.call(t, n, 1), --this.size, !0);
			}
			function Mr(e) {
			...
			kr.prototype.clear = Ar, kr.prototype.delete = jr, kr.prototype.get = Mr, kr.prototype.has = Nr, kr.prototype.set = Pr;
			function Fr(e) {
				var t = -1, n = e == null ? 0 : e.length;
				for (this.clear(); ++t < n;) {
					var r = e[t];
			...
			Fr.prototype.clear = Ir, Fr.prototype.delete = Lr, Fr.prototype.get = Rr, Fr.prototype.has = zr, Fr.prototype.set = Br;
			function Vr(e) {
				var t = -1, n = e == null ? 0 : e.length;
			...
			Vr.prototype.add = Vr.prototype.push = Hr, Vr.prototype.has = Ur;
			function Wr(e) {
			...
			function Yr(e, t) {
				...
				if (n instanceof kr) {
					var r = n.__data__;
					if (!$t || r.length < 199) return r.push([e, t]), this.size = ++n.size, this;
					n = this.__data__ = new Fr(r);
				}
				return n.set(e, t), this.size = n.size, this;
			}
			Wr.prototype.clear = Gr, Wr.prototype.delete = Kr, Wr.prototype.get = qr, Wr.prototype.has = Jr, Wr.prototype.set = Yr;
			function Xr(e, t) {
				var n = q(e), r = !n && Yl(e), i = !n && !r && $l(e), a = !n && !r && !i && wu(e), o = n || r || i || a, s = o ? In(e.length, dt) : [], c = s.length;
				for (var l in e) (t || k.call(e, l)) && !(o && (l == "length" || i && (l == "offset" || l == "parent") || a && (l == "buffer" || l == "byteLength" || l == "byteOffset") || Jo(l, c))) && s.push(l);
				return s;
			}
			function Zr(e) {
				var t = e.length;
				return t ? e[ca(0, t - 1)] : n;
			}
			function Qr(e, t) {
				return _s(qa(e), ci(t, 0, e.length));
			}
			function $r(e) {
				return _s(qa(e));
			}
			function ei(e, t, r) {
				(r !== n && !Kl(e[t], r) || r === n && !(t in e)) && oi(e, t, r);
			}
			function ti(e, t, r) {
				var i = e[t];
				(!(k.call(e, t) && Kl(i, r)) || r === n && !(t in e)) && oi(e, t, r);
			}
			function ni(e, t) {
			...
			function si(e, t) {
				for (var r = -1, i = t.length, a = T(i), o = e == null; ++r < i;) a[r] = o ? n : Qu(e, t[r]);
				return a;
			}
			function ci(e, t, r) {
				return e === e && (r !== n && (e = e <= r ? e : r), t !== n && (e = e >= t ? e : t)), e;
			}
			function li(e, t, r, i, a, o) {
				var s, c = t & 1, l = t & 2, u = t & 4;
				if (r && (s = a ? r(e, i, a, o) : r(e)), s !== n) return s;
				if (!Y(e)) return e;
				var d = q(e);
				if (d) {
					if (s = Uo(e), !c) return qa(e, s);
				} else {
					var f = K(e), p = f == se || f == ce;
					if ($l(e)) return La(e, c);
					if (f == fe || f == ee || p && !a) {
						if (s = l || p ? {} : Wo(e), !c) return l ? Xa(e, ai(s, e)) : Ya(e, ii(s, e));
					} else {
						if (!F[f]) return a ? e : {};
						s = Go(e, f, c);
					}
				...
				var m = o.get(e);
				if (m) return m;
				o.set(e, s), xu(e) ? e.forEach(function(n) {
					s.add(li(n, t, r, n, e, o));
				}) : uu(e) && e.forEach(function(n, i) {
					s.set(i, li(n, t, r, i, e, o));
				});
				var h = d ? n : (u ? l ? Ao : ko : l ? id : $)(e);
				return fn(h || e, function(n, i) {
					h && (i = n, n = e[i]), ti(s, i, li(n, t, r, i, e, o));
				}), s;
			}
			function ui(e) {
				var t = $(e);
			...
			function fi(e, t, i) {
				if (typeof e != "function") throw new O(r);
				return ps(function() {
					e.apply(n, i);
				}, t);
			}
			function pi(e, t, n, r) {
				var i = -1, a = gn, o = !0, s = e.length, c = [], l = t.length;
				if (!s) return c;
				n && (t = z(t, zn(n))), r ? (a = _n, o = !1) : t.length >= 200 && (a = Vn, o = !1, t = new Vr(t));
				outer: for (; ++i < s;) {
			...
			var mi = $a(Si), hi = $a(Ci, !0);
			function gi(e, t) {
				var n = !0;
				return mi(e, function(e, r, i) {
					return n = !!t(e, r, i), n;
				}), n;
			}
			function _i(e, t, r) {
				for (var i = -1, a = e.length; ++i < a;) {
					var o = e[i], s = t(o);
					if (s != null && (c === n ? s === s && !Cu(s) : r(s, c))) var c = s, l = o;
				}
				return l;
			}
			function vi(e, t, r, i) {
				var a = e.length;
				for (r = Z(r), r < 0 && (r = -r > a ? 0 : a + r), i = i === n || i > a ? a : Z(i), i < 0 && (i += a), i = r > i ? 0 : Mu(i); r < i;) e[r++] = t;
				return e;
			}
			function yi(e, t) {
				var n = [];
			...
			function U(e, t, n, r, i) {
				...
				for (n ||= qo, i ||= []; ++a < o;) {
					var s = e[a];
					t > 0 && n(s) ? t > 1 ? U(s, t - 1, n, r, i) : vn(i, s) : r || (i[i.length] = s);
				}
				return i;
			}
			var bi = eo(), xi = eo(!0);
			...
			function Ti(e, t) {
				t = Na(t, e);
				for (var r = 0, i = t.length; e != null && r < i;) e = e[ys(t[r++])];
				return r && r == i ? e : n;
			}
			function Ei(e, t, n) {
				var r = t(e);
				return q(e) ? r : vn(r, n(e));
			}
			function Di(e) {
				return e == null ? e === n ? ve : de : A && A in D(e) ? Lo(e) : ss(e);
			}
			function Oi(e, t) {
				return e > t;
			}
			...
			function ji(e, t, n) {
				return e >= I(t, n) && e < N(t, n);
			}
			function Mi(e, t, r) {
				for (var i = r ? _n : gn, a = e[0].length, o = e.length, s = o, c = T(o), l = Infinity, u = []; s--;) {
					var d = e[s];
					s && t && (d = z(d, zn(t))), l = I(d.length, l), c[s] = !r && (t || a >= 120 && d.length >= 120) ? new Vr(s && d) : n;
				}
				d = e[0];
				var f = -1, p = c[0];
				outer: for (; ++f < a && u.length < l;) {
					var m = d[f], h = t ? t(m) : m;
					if (m = r || m !== 0 ? m : 0, !(p ? Vn(p, h) : i(u, h, r))) {
						for (s = o; --s;) {
							var g = c[s];
							if (!(g ? Vn(g, h) : i(e[s], h, r))) continue outer;
						}
						p && p.push(h), u.push(m);
					}
				}
			...
			function Ni(e, t, n, r) {
				return Si(e, function(e, i, a) {
					t(r, n(e), i, a);
				}), r;
			}
			function Pi(e, t, r) {
				t = Na(t, e), e = ls(e, t);
				var i = e == null ? e : e[ys(qs(t))];
				return i == null ? n : un(i, e, r);
			}
			function Fi(e) {
				return X(e) && Di(e) == ee;
			}
			...
			function Ri(e, t, n, r, i) {
				return e === t ? !0 : e == null || t == null || !X(e) && !X(t) ? e !== e && t !== t : zi(e, t, n, r, Ri, i);
			}
			function zi(e, t, n, r, i, a) {
				var o = q(e), s = q(t), c = o ? te : K(e), l = s ? te : K(t);
				c = c == ee ? fe : c, l = l == ee ? fe : l;
				var u = c == fe, d = l == fe, f = c == l;
				if (f && $l(e)) {
					if (!$l(t)) return !1;
					o = !0, u = !1;
				}
				if (f && !u) return a ||= new Wr(), o || wu(e) ? To(e, t, n, r, i, a) : Eo(e, t, c, n, r, i, a);
				if (!(n & 1)) {
					var p = u && k.call(e, "__wrapped__"), m = d && k.call(t, "__wrapped__");
					if (p || m) {
						var h = p ? e.value() : e, g = m ? t.value() : t;
						return a ||= new Wr(), i(h, g, n, r, a);
					}
				}
				return f ? (a ||= new Wr(), Do(e, t, n, r, i, a)) : !1;
			}
			function Bi(e) {
				return X(e) && K(e) == le;
			}
			function Vi(e, t, r, i) {
				...
				for (; ++a < o;) {
					...
					if (s && c[2]) {
						...
						if (!(p === n ? Ri(d, u, 3, i, f) : p)) return !1;
					}
				}
				return !0;
			}
			function Hi(e) {
				return !Y(e) || $o(e) ? !1 : (su(e) ? St : tt).test(bs(e));
			}
			function Ui(e) {
				return X(e) && Di(e) == he;
			}
			...
			function Gi(e) {
				return X(e) && lu(e.length) && !!P[Di(e)];
			}
			function Ki(e) {
				return typeof e == "function" ? e : e == null ? ff : typeof e == "object" ? q(e) ? Qi(e[0], e[1]) : Zi(e) : Tf(e);
			}
			function qi(e) {
				if (!ts(e)) return Ut(e);
				var t = [];
				for (var n in D(e)) k.call(e, n) && n != "constructor" && t.push(n);
				return t;
			}
			function Ji(e) {
				if (!Y(e)) return os(e);
			...
			function Qi(e, t) {
				return Xo(e) && ns(t) ? rs(ys(e), t) : function(r) {
					var i = Qu(r, e);
					return i === n && i === t ? ed(r, e) : Ri(t, i, 3);
				};
			}
			function $i(e, t, r, i, a) {
				e !== t && bi(t, function(o, s) {
					if (a ||= new Wr(), Y(o)) ea(e, t, s, r, $i, i, a);
					else {
			...
			function ea(e, t, r, i, a, o, s) {
				...
				if (f) {
					var p = q(l), m = !p && $l(l), h = !p && !m && wu(l);
					d = l, p || m || h ? q(c) ? d = c : J(c) ? d = qa(c) : m ? (f = !1, d = La(l, !0)) : h ? (f = !1, d = Ha(l, !0)) : d = [] : vu(l) || Yl(l) ? (d = c, Yl(c) ? d = Pu(c) : (!Y(c) || su(c)) && (d = Wo(l))) : f = !1;
				}
				f && (s.set(l, d), a(d, l, i, o, s), s.delete(l)), ei(e, r, d);
			}
			function ta(e, t) {
				var r = e.length;
				if (r) return t += t < 0 ? r : 0, Jo(t, r) ? e[t] : n;
			}
			function na(e, t, n) {
				t = t.length ? z(t, function(e) {
					return q(e) ? function(t) {
						return Ti(t, e.length === 1 ? e[0] : e);
					} : e;
				}) : [ff];
				var r = -1;
				return t = z(t, zn(G())), Pn(Xi(e, function(e, n, i) {
					return {
						criteria: z(t, function(t) {
							return t(e);
						}),
						index: ++r,
						value: e
			...
			function oa(e, t, n, r) {
				var i = r ? On : Dn, a = -1, o = t.length, s = e;
				for (e === t && (t = qa(t)), n && (s = z(e, zn(n))); ++a < o;) for (var c = 0, l = t[a], u = n ? n(l) : l; (c = i(s, u, c, r)) > -1;) s !== e && At.call(s, c, 1), At.call(e, c, 1);
				return e;
			}
			function sa(e, t) {
				for (var n = e ? t.length : 0, r = n - 1; n--;) {
					...
					if (n == r || i !== a) {
						var a = i;
						Jo(i) ? At.call(e, i, 1) : Ta(e, i);
					}
				}
				return e;
			}
			function ca(e, t) {
				return e + It(Jt() * (t - e + 1));
			}
			function la(e, t, n, r) {
				for (var i = -1, a = N(Ft((t - e) / (n || 1)), 0), o = T(a); a--;) o[r ? a : ++i] = e, e += n;
				return o;
			}
			function ua(e, t) {
				var n = "";
			...
			function pa(e, t, r, i) {
				...
				for (var a = -1, o = t.length, s = o - 1, c = e; c != null && ++a < o;) {
					...
					if (a != s) {
						var d = c[l];
						u = i ? i(d, l, c) : n, u === n && (u = Y(d) ? d : Jo(t[a + 1]) ? [] : {});
					}
					ti(c, l, u), c = c[l];
				}
				return e;
			}
			var ma = Cn ? function(e, t) {
				return Cn.set(e, t), e;
			} : ff, ha = Nt ? function(e, t) {
			...
			function ya(e, t, n) {
				...
				if (typeof t == "number" && t === t && i <= b) {
					for (; r < i;) {
						var a = r + i >>> 1, o = e[a];
						o !== null && !Cu(o) && (n ? o <= t : o < t) ? r = a + 1 : i = a;
					}
					return i;
				}
				return ba(e, t, ff, n);
			...
			function ba(e, t, r, i) {
				...
				if (o === 0) return 0;
				t = r(t);
				for (var s = t !== t, c = t === null, l = Cu(t), u = t === n; a < o;) {
					var d = It((a + o) / 2), f = r(e[d]), p = f !== n, m = f === null, h = f === f, g = Cu(f);
					if (s) var _ = i || h;
			...
			function Sa(e) {
				return typeof e == "number" ? e : Cu(e) ? _ : +e;
			}
			function Ca(e) {
				if (typeof e == "string") return e;
				if (q(e)) return z(e, Ca) + "";
				if (Cu(e)) return gr ? gr.call(e) : "";
				var t = e + "";
				return t == "0" && 1 / e == -Infinity ? "-0" : t;
			}
			function wa(e, t, n) {
				var r = -1, i = gn, a = e.length, o = !0, s = [], c = s;
				if (n) o = !1, i = _n;
				else if (a >= 200) {
					var l = t ? null : yo(e);
					if (l) return er(l);
			...
			function Ta(e, t) {
				...
				var a = ls(e, t);
				return a == null || delete a[ys(qs(t))];
			}
			function Ea(e, t, n, r) {
				return pa(e, t, n(Ti(e, t)), r);
			}
			function Da(e, t, n, r) {
				for (var i = e.length, a = r ? i : -1; (r ? a-- : ++a < i) && t(e[a], a, e););
				return n ? _a(e, r ? 0 : a, r ? a + 1 : i) : _a(e, r ? a + 1 : 0, r ? i : a);
			}
			function Oa(e, t) {
				var n = e;
				return n instanceof H && (n = n.value()), yn(t, function(e, t) {
			...
			function ka(e, t, n) {
				...
				for (var i = -1, a = T(r); ++i < r;) for (var o = e[i], s = -1; ++s < r;) s != i && (a[i] = pi(a[i] || o, e[s], t, n));
				return wa(U(a, 1), t, n);
			}
			function Aa(e, t, r) {
			...
			function Na(e, t) {
				return q(e) ? e : Xo(e, t) ? [e] : vs(Q(e));
			}
			var Pa = W;
			function Fa(e, t, r) {
				var i = e.length;
				return r = r === n ? i : r, !t && r >= i ? e : _a(e, t, r);
			}
			var Ia = j || function(e) {
			...
			function Ua(e, t) {
				if (e !== t) {
					var r = e !== n, i = e === null, a = e === e, o = Cu(e), s = t !== n, c = t === null, l = t === t, u = Cu(t);
			...
			function Ga(e, t, n, r) {
				for (var i = -1, a = e.length, o = n.length, s = -1, c = t.length, l = N(a - o, 0), u = T(c + l), d = !r; ++s < c;) u[s] = t[s];
				for (; ++i < o;) (d || i < a) && (u[n[i]] = e[i]);
				for (; l--;) u[s++] = e[i++];
				return u;
			}
			function Ka(e, t, n, r) {
				for (var i = -1, a = e.length, o = -1, s = n.length, c = -1, l = t.length, u = N(a - s, 0), d = T(u + l), f = !r; ++i < u;) d[i] = e[i];
			...
			function Qa(e) {
				return W(function(t, r) {
					...
					for (o = e.length > 3 && typeof o == "function" ? (a--, o) : n, s && Yo(r[0], r[1], s) && (o = a < 3 ? n : o, a = 1), t = D(t); ++i < a;) {
						var c = r[i];
						c && e(t, c, i, o);
					}
					return t;
			...
			function $a(e, t) {
				return function(n, r) {
					...
					for (var i = n.length, a = t ? i : -1, o = D(n); (t ? a-- : ++a < i) && r(o[a], a, o) !== !1;);
					return n;
				};
			}
			function eo(e) {
				return function(t, n, r) {
					for (var i = -1, a = D(t), o = r(t), s = o.length; s--;) {
						var c = o[e ? s : ++i];
			...
			function to(e, t, n) {
				var r = t & o, i = io(e);
				function a() {
					return (this && this !== L && this instanceof a ? i : e).apply(r ? n : this, arguments);
				}
				return a;
			}
			function no(e) {
				return function(t) {
					t = Q(t);
					var r = Yn(t) ? ar(t) : n, i = r ? r[0] : t.charAt(0), a = r ? Fa(r, 1).join("") : t.slice(1);
					return i[e]() + a;
				};
			}
			function ro(e) {
				return function(t) {
					return yn(nf(kd(t).replace(zt, "")), e, "");
				};
			}
			function io(e) {
				return function() {
			...
			function ao(e, t, r) {
				var i = io(e);
				function a() {
					for (var o = arguments.length, s = T(o), c = o, l = No(a); c--;) s[c] = arguments[c];
					var u = o < 3 && s[0] !== l && s[o - 1] !== l ? [] : B(s, l);
					return o -= u.length, o < r ? _o(e, t, co, a.placeholder, n, s, u, n, n, r - o) : un(this && this !== L && this instanceof a ? i : e, this, s);
				}
				return a;
			}
			function oo(e) {
			...
			function so(e) {
				return Oo(function(t) {
					var i = t.length, a = i, o = yr.prototype.thru;
					for (e && t.reverse(); a--;) {
						var s = t[a];
						if (typeof s != "function") throw new O(r);
						if (o && !l && Mo(s) == "wrapper") var l = new yr([], !0);
					}
					for (a = l ? a : i; ++a < i;) {
						s = t[a];
						var d = Mo(s), m = d == "wrapper" ? jo(s) : n;
						l = m && Qo(m[0]) && m[1] == (f | c | u | p) && !m[4].length && m[9] == 1 ? l[Mo(m[0])].apply(l, m[3]) : s.length == 1 && Qo(s) ? l[d]() : l.thru(s);
					}
					return function() {
			...
			function co(e, t, r, i, a, u, d, p, h, g) {
				var _ = t & f, v = t & o, y = t & s, b = t & (c | l), x = t & m, ee = y ? n : io(e);
				function te() {
					for (var n = arguments.length, o = T(n), s = n; s--;) o[s] = arguments[s];
					if (b) var c = No(te), l = Wn(o, c);
					if (i && (o = Ga(o, i, a, b)), u && (o = Ka(o, u, d, b)), n -= l, b && n < g) {
						var f = B(o, c);
						return _o(e, t, co, te.placeholder, r, o, f, p, h, g - n);
					}
					var m = v ? r : this, ne = y ? m[e] : e;
					return n = o.length, p ? o = us(o, p) : x && n > 1 && o.reverse(), _ && h < n && (o.length = h), this && this !== L && this instanceof te && (ne = ee || io(ne)), ne.apply(m, o);
				}
				return te;
			}
			function lo(e, t) {
			...
			function uo(e, t) {
				return function(r, i) {
					...
					if (r !== n && (a = r), i !== n) {
						if (a === n) return i;
						typeof r == "string" || typeof i == "string" ? (r = Ca(r), i = Ca(i)) : (r = Sa(r), i = Sa(i)), a = e(r, i);
					}
					return a;
				};
			}
			function fo(e) {
				return Oo(function(t) {
					return t = z(t, zn(G())), W(function(n) {
						var r = this;
			...
			function po(e, t) {
				t = t === n ? " " : Ca(t);
				var r = t.length;
				if (r < 2) return r ? ua(t, e) : t;
				var i = ua(t, Ft(e / ir(t)));
				return Yn(t) ? Fa(ar(i), 0, e).join("") : i.slice(0, e);
			}
			function mo(e, t, n, r) {
				var i = t & o, a = io(e);
				function s() {
					for (var t = -1, o = arguments.length, c = -1, l = r.length, u = T(l + o), d = this && this !== L && this instanceof s ? a : e; ++c < l;) u[c] = r[c];
					for (; o--;) u[c++] = arguments[++t];
					return un(d, i ? n : this, u);
				}
				return s;
			}
			function ho(e) {
				return function(t, r, i) {
					return i && typeof i != "number" && Yo(t, r, i) && (r = i = n), t = ju(t), r === n ? (r = t, t = 0) : r = ju(r), i = i === n ? t < r ? 1 : -1 : ju(i), la(t, r, i, e);
				};
			}
			function go(e) {
				return function(t, n) {
					return typeof t == "string" && typeof n == "string" || (t = Nu(t), n = Nu(n)), e(t, n);
				};
			}
			function _o(e, t, r, i, a, l, f, p, m, h) {
				...
				return Qo(e) && fs(ee, x), ee.placeholder = i, hs(ee, e, t);
			}
			function vo(e) {
				var t = lt[e];
				return function(e, n) {
					if (e = Nu(e), n = n == null ? 0 : I(Z(n), 292), n && Vt(e)) {
						var r = (Q(e) + "e").split("e");
			...
			var yo = nn && 1 / er(new nn([, -0]))[1] == h ? function(e) {
				return new nn(e);
			} : bf;
			function bo(e) {
				return function(t) {
					var n = K(t);
					return n == le ? Qn(t) : n == S ? tr(t) : Ln(t, e(t));
				};
			}
			function xo(e, t, i, a, f, p, m, h) {
				var g = t & s;
				if (!g && typeof e != "function") throw new O(r);
				var _ = a ? a.length : 0;
				if (_ || (t &= ~(u | d), a = f = n), m = m === n ? m : N(Z(m), 0), h = h === n ? h : Z(h), _ -= f ? f.length : 0, t & d) {
					var v = a, y = f;
					a = f = n;
				}
				var b = g ? n : jo(e), x = [
				...
				if (b && as(x, b), e = x[0], t = x[1], i = x[2], a = x[3], f = x[4], h = x[9] = x[9] === n ? g ? 0 : e.length : N(x[9] - _, 0), !h && t & (c | l) && (t &= ~(c | l)), !t || t == o) var ee = to(e, t, i);
				else ee = t == c || t == l ? ao(e, t, h) : (t == u || t == (o | u)) && !f.length ? mo(e, t, i, a) : co.apply(n, x);
				return hs((b ? ma : fs)(ee, x), e, t);
			}
			function So(e, t, r, i) {
				return e === n || Kl(e, mt[r]) && !k.call(i, r) ? t : e;
			}
			function Co(e, t, r, i, a, o) {
				return Y(e) && Y(t) && (o.set(t, e), $i(e, t, n, Co, o), o.delete(t)), e;
			}
			function wo(e) {
				return vu(e) ? n : e;
			}
			function To(e, t, r, i, a, o) {
				var s = r & 1, c = e.length, l = t.length;
				if (c != l && !(s && l > c)) return !1;
				var u = o.get(e), d = o.get(t);
				if (u && d) return u == t && d == e;
				var f = -1, p = !0, m = r & 2 ? new Vr() : n;
				for (o.set(e, t), o.set(t, e); ++f < c;) {
					...
					if (m) {
						if (!xn(t, function(e, t) {
							if (!Vn(m, t) && (h === e || a(h, e, r, i, o))) return m.push(t);
						})) {
							p = !1;
							break;
						}
			...
			function Eo(e, t, n, r, i, a, o) {
				switch (n) {
					...
					case xe: return !(e.byteLength != t.byteLength || !a(new Tt(e), new Tt(t)));
					case re:
					case ie:
					case ue: return Kl(+e, +t);
					...
					case S:
						...
						if (l) return l == t;
						r |= 2, o.set(e, t);
						var u = To(s(e), s(t), r, i, a, o);
						return o.delete(e), u;
					case _e: if (hr) return hr.call(e) == hr.call(t);
				}
				return !1;
			}
			function Do(e, t, r, i, a, o) {
				var s = r & 1, c = ko(e), l = c.length;
			...
			var jo = Cn ? function(e) {
				return Cn.get(e);
			} : bf;
			function Mo(e) {
				for (var t = e.name + "", n = Mn[t], r = k.call(Mn, t) ? n.length : 0; r--;) {
					var i = n[r], a = i.func;
			...
			function No(e) {
				return (k.call(V, "placeholder") ? V : e).placeholder;
			}
			function G() {
				var e = V.iteratee || pf;
				return e = e === pf ? Ki : e, arguments.length ? e(arguments[0], arguments[1]) : e;
			}
			function Po(e, t) {
				var n = e.__data__;
			...
			function Lo(e) {
				var t = k.call(e, A), r = e[A];
				try {
					e[A] = n;
					var i = !0;
				} catch {}
				var a = yt.call(e);
				return i && (t ? e[A] = r : delete e[A]), a;
			}
			var Ro = Lt ? function(e) {
				return e == null ? [] : (e = D(e), hn(Lt(e), function(t) {
					return kt.call(e, t);
				}));
			} : kf, zo = Lt ? function(e) {
				for (var t = []; e;) vn(t, Ro(e)), e = Dt(e);
				return t;
			} : kf, K = Di;
			(Qt && K(new Qt(/* @__PURE__ */ new ArrayBuffer(1))) != Se || $t && K(new $t()) != le || en && K(en.resolve()) != pe || nn && K(new nn()) != S || R && K(new R()) != ye) && (K = function(e) {
				var t = Di(e), r = t == fe ? e.constructor : n, i = r ? bs(r) : "";
				if (i) switch (i) {
					case nr: return Se;
					case cr: return le;
					case lr: return pe;
			...
			function Ho(e, t, n) {
				...
				return a || ++r != i ? a : (i = e == null ? 0 : e.length, !!i && lu(i) && Jo(o, i) && (q(e) || Yl(e)));
			}
			function Uo(e) {
			...
			function Wo(e) {
				return typeof e.constructor == "function" && !ts(e) ? _r(Dt(e)) : {};
			}
			function Go(e, t, n) {
				var r = e.constructor;
				switch (t) {
					case xe: return Ra(e);
					case re:
					case ie: return new r(+e);
					case Se: return za(e, n);
					case Ce:
					case C:
					case we:
					case Te:
					...
					case De:
					case Oe:
					case ke: return Ha(e, n);
					case le: return new r();
					case ue:
			...
			function qo(e) {
				return q(e) || Yl(e) || !!(jt && e && e[jt]);
			}
			function Jo(e, t) {
				var n = typeof e;
				return t ??= g, !!t && (n == "number" || n != "symbol" && rt.test(e)) && e > -1 && e % 1 == 0 && e < t;
			}
			function Yo(e, t, n) {
				if (!Y(n)) return !1;
				var r = typeof t;
				return (r == "number" ? Zl(n) && Jo(t, n.length) : r == "string" && t in n) ? Kl(n[t], e) : !1;
			}
			function Xo(e, t) {
				if (q(e)) return !1;
				var n = typeof e;
				return n == "number" || n == "symbol" || n == "boolean" || e == null || Cu(e) ? !0 : Ve.test(e) || !Be.test(e) || t != null && e in D(t);
			}
			function Zo(e) {
				var t = typeof e;
			...
			function rs(e, t) {
				return function(r) {
					return r != null && r[e] === t && (t !== n || e in D(r));
				};
			}
			function is(e) {
				var t = Ol(e, function(e) {
			...
			function as(e, t) {
				...
				if (d) {
					var m = e[3];
					e[3] = m ? Ga(m, d, t[4]) : d, e[4] = m ? B(e[3], a) : t[4];
				}
				return d = t[5], d && (m = e[5], e[5] = m ? Ka(m, d, t[6]) : d, e[6] = m ? B(e[5], a) : t[6]), d = t[7], d && (e[7] = d), r & f && (e[8] = e[8] == null ? t[8] : I(e[8], t[8])), e[9] ??= t[9], e[0] = t[0], e[1] = i, e;
			}
			function os(e) {
				var t = [];
				if (e != null) for (var n in D(e)) t.push(n);
				return t;
			}
			function ss(e) {
				return yt.call(e);
			...
			function cs(e, t, r) {
				return t = N(t === n ? e.length - 1 : t, 0), function() {
					for (var n = arguments, i = -1, a = N(n.length - t, 0), o = T(a); ++i < a;) o[i] = n[t + i];
					i = -1;
					for (var s = T(t + 1); ++i < t;) s[i] = n[i];
					return s[t] = r(o), un(e, this, s);
				};
			}
			function ls(e, t) {
				return t.length < 2 ? e : Ti(e, _a(t, 0, -1));
			}
			function us(e, t) {
				for (var r = e.length, i = I(t.length, r), a = qa(e); i--;) {
					var o = t[i];
					e[i] = Jo(o, r) ? a[o] : n;
				}
				return e;
			...
			var fs = gs(ma), ps = M || function(e, t) {
				return L.setTimeout(e, t);
			}, ms = gs(ha);
			function hs(e, t, n) {
				var r = t + "";
				return ms(e, Ko(r, xs(Vo(r), n)));
			}
			function gs(e) {
				var t = 0, r = 0;
				return function() {
			...
			var vs = is(function(e) {
				var t = [];
				return e.charCodeAt(0) === 46 && t.push(""), e.replace(He, function(e, n, r, i) {
			...
			function Cs(e, t, r) {
				t = (r ? Yo(e, t, r) : t === n) ? 1 : N(Z(t), 0);
				var i = e == null ? 0 : e.length;
				if (!i || t < 1) return [];
				for (var a = 0, o = 0, s = T(Ft(i / t)); a < i;) s[o++] = _a(e, a, a += t);
				return s;
			}
			function ws(e) {
			...
			function Ts() {
				...
				return vn(q(n) ? qa(n) : [n], U(t, 1));
			}
			var Es = W(function(e, t) {
				return J(e) ? pi(e, U(t, 1, J, !0)) : [];
			}), Ds = W(function(e, t) {
				var r = qs(t);
				return J(r) && (r = n), J(e) ? pi(e, U(t, 1, J, !0), G(r, 2)) : [];
			}), Os = W(function(e, t) {
				var r = qs(t);
				return J(r) && (r = n), J(e) ? pi(e, U(t, 1, J, !0), n, r) : [];
			});
			function ks(e, t, r) {
				var i = e == null ? 0 : e.length;
				return i ? (t = r || t === n ? 1 : Z(t), _a(e, t < 0 ? 0 : t, i)) : [];
			}
			function As(e, t, r) {
				var i = e == null ? 0 : e.length;
				return i ? (t = r || t === n ? 1 : Z(t), t = i - t, _a(e, 0, t < 0 ? 0 : t)) : [];
			}
			function js(e, t) {
				return e && e.length ? Da(e, G(t, 3), !0, !0) : [];
			}
			function Ms(e, t) {
				return e && e.length ? Da(e, G(t, 3), !0) : [];
			}
			function Ns(e, t, n, r) {
				var i = e == null ? 0 : e.length;
				return i ? (n && typeof n != "number" && Yo(e, t, n) && (n = 0, r = i), vi(e, t, n, r)) : [];
			}
			function Ps(e, t, n) {
				var r = e == null ? 0 : e.length;
				if (!r) return -1;
				var i = n == null ? 0 : Z(n);
				return i < 0 && (i = N(r + i, 0)), En(e, G(t, 3), i);
			}
			function Fs(e, t, r) {
				var i = e == null ? 0 : e.length;
				if (!i) return -1;
				var a = i - 1;
				return r !== n && (a = Z(r), a = r < 0 ? N(i + a, 0) : I(a, i - 1)), En(e, G(t, 3), a, !0);
			}
			function Is(e) {
				return e != null && e.length ? U(e, 1) : [];
			}
			function Ls(e) {
				return e != null && e.length ? U(e, h) : [];
			}
			function Rs(e, t) {
			...
			function Vs(e, t, n) {
				...
				if (!r) return -1;
				var i = n == null ? 0 : Z(n);
				return i < 0 && (i = N(r + i, 0)), Dn(e, t, i);
			}
			function Hs(e) {
				return e != null && e.length ? _a(e, 0, -1) : [];
			}
			var Us = W(function(e) {
				var t = z(e, ja);
				...
				var t = qs(e), r = z(e, ja);
				return t === qs(r) ? t = n : r.pop(), r.length && r[0] === e[0] ? Mi(r, G(t, 2)) : [];
			}), Gs = W(function(e) {
				var t = qs(e), r = z(e, ja);
				return t = typeof t == "function" ? t : n, t && r.pop(), r.length && r[0] === e[0] ? Mi(r, n, t) : [];
			});
			function Ks(e, t) {
				return e == null ? "" : Ht.call(e, t);
			}
			function qs(e) {
			...
			function Js(e, t, r) {
				...
				if (!i) return -1;
				var a = i;
				return r !== n && (a = Z(r), a = a < 0 ? N(i + a, 0) : I(a, i - 1)), t === t ? rr(e, t, a) : En(e, kn, a, !0);
			}
			function Ys(e, t) {
				return e && e.length ? ta(e, Z(t)) : n;
			}
			var Xs = W(Zs);
			function Zs(e, t) {
			...
			function Qs(e, t, n) {
				return e && e.length && t && t.length ? oa(e, t, G(n, 2)) : e;
			}
			function $s(e, t, r) {
				return e && e.length && t && t.length ? oa(e, t, n, r) : e;
			}
			var ec = Oo(function(e, t) {
				var n = e == null ? 0 : e.length, r = si(e, t);
				return sa(e, z(t, function(e) {
					return Jo(e, n) ? +e : e;
				}).sort(Ua)), r;
			});
			function tc(e, t) {
			...
			function nc(e) {
				return e == null ? e : Zt.call(e);
			}
			function rc(e, t, r) {
				var i = e == null ? 0 : e.length;
				return i ? (r && typeof r != "number" && Yo(e, t, r) ? (t = 0, r = i) : (t = t == null ? 0 : Z(t), r = r === n ? i : Z(r)), _a(e, t, r)) : [];
			}
			function ic(e, t) {
				return ya(e, t);
			}
			...
			function pc(e, t, r) {
				return e && e.length ? (t = r || t === n ? 1 : Z(t), _a(e, 0, t < 0 ? 0 : t)) : [];
			}
			function mc(e, t, r) {
				var i = e == null ? 0 : e.length;
				return i ? (t = r || t === n ? 1 : Z(t), t = i - t, _a(e, t < 0 ? 0 : t, i)) : [];
			}
			function hc(e, t) {
				return e && e.length ? Da(e, G(t, 3), !1, !0) : [];
			}
			function gc(e, t) {
				return e && e.length ? Da(e, G(t, 3)) : [];
			}
			var _c = W(function(e) {
				return wa(U(e, 1, J, !0));
			}), vc = W(function(e) {
				var t = qs(e);
				return J(t) && (t = n), wa(U(e, 1, J, !0), G(t, 2));
			}), yc = W(function(e) {
				var t = qs(e);
				return t = typeof t == "function" ? t : n, wa(U(e, 1, J, !0), n, t);
			});
			function bc(e) {
			...
			function Cc(e) {
				...
				var t = 0;
				return e = hn(e, function(e) {
					if (J(e)) return t = N(e.length, t), !0;
				}), In(t, function(t) {
					return z(e, jn(t));
				});
			}
			function wc(e, t) {
				if (!(e && e.length)) return [];
				var r = Cc(e);
				return t == null ? r : z(r, function(e) {
					return un(t, n, e);
				});
			}
			var Tc = W(function(e, t) {
				return J(e) ? pi(e, t) : [];
			}), Ec = W(function(e) {
				return ka(hn(e, J));
			}), Dc = W(function(e) {
				var t = qs(e);
				return J(t) && (t = n), ka(hn(e, J), G(t, 2));
			}), Oc = W(function(e) {
				var t = qs(e);
				return t = typeof t == "function" ? t : n, ka(hn(e, J), n, t);
			}), kc = W(Cc);
			function Ac(e, t) {
				return Aa(e || [], t || [], ti);
			}
			...
			var Ic = Oo(function(e) {
				var t = e.length, r = t ? e[0] : 0, i = this.__wrapped__, a = function(t) {
					return si(t, e);
				};
				return t > 1 || this.__actions__.length || !(i instanceof H) || !Jo(r) ? this.thru(a) : (i = i.slice(r, +r + +!!t), i.__actions__.push({
					func: Fc,
					args: [a],
					thisArg: n
				}), new yr(i, this.__chain__).thru(function(e) {
			...
			function zc() {
				this.__values__ === n && (this.__values__ = Au(this.value()));
			...
			var Wc = Za(function(e, t, n) {
				k.call(e, n) ? ++e[n] : oi(e, n, 1);
			});
			function Gc(e, t, r) {
				var i = q(e) ? mn : gi;
				return r && Yo(e, t, r) && (t = n), i(e, G(t, 3));
			}
			function Kc(e, t) {
				return (q(e) ? hn : yi)(e, G(t, 3));
			}
			var qc = oo(Ps), Jc = oo(Fs);
			function Yc(e, t) {
				return U(il(e, t), 1);
			}
			function Xc(e, t) {
			...
			function Zc(e, t, r) {
				return r = r === n ? 1 : Z(r), U(il(e, t), r);
			}
			function Qc(e, t) {
				return (q(e) ? fn : mi)(e, G(t, 3));
			}
			function $c(e, t) {
				return (q(e) ? pn : hi)(e, G(t, 3));
			}
			var el = Za(function(e, t, n) {
				k.call(e, n) ? e[n].push(t) : oi(e, n, [t]);
			});
			function tl(e, t, n, r) {
				e = Zl(e) ? e : Sd(e), n = n && !r ? Z(n) : 0;
				var i = e.length;
				return n < 0 && (n = N(i + n, 0)), Su(e) ? n <= i && e.indexOf(t, n) > -1 : !!i && Dn(e, t, n) > -1;
			}
			var nl = W(function(e, t, n) {
				var r = -1, i = typeof t == "function", a = Zl(e) ? T(e.length) : [];
				return mi(e, function(e) {
					a[++r] = i ? un(t, e, n) : Pi(e, t, n);
				}), a;
			}), rl = Za(function(e, t, n) {
				oi(e, n, t);
			});
			function il(e, t) {
				return (q(e) ? z : Xi)(e, G(t, 3));
			}
			function al(e, t, r, i) {
				return e == null ? [] : (q(t) || (t = t == null ? [] : [t]), r = i ? n : r, q(r) || (r = r == null ? [] : [r]), na(e, t, r));
			}
			...
			function sl(e, t, n) {
				var r = q(e) ? yn : Nn, i = arguments.length < 3;
				return r(e, G(t, 4), n, i, mi);
			}
			function cl(e, t, n) {
				var r = q(e) ? bn : Nn, i = arguments.length < 3;
				return r(e, G(t, 4), n, i, hi);
			}
			function ll(e, t) {
				return (q(e) ? hn : yi)(e, kl(G(t, 3)));
			}
			function ul(e) {
				return (q(e) ? Zr : da)(e);
			}
			function dl(e, t, r) {
				return t = (r ? Yo(e, t, r) : t === n) ? 1 : Z(t), (q(e) ? Qr : fa)(e, t);
			}
			function fl(e) {
				return (q(e) ? $r : ga)(e);
			}
			function pl(e) {
				if (e == null) return 0;
				if (Zl(e)) return Su(e) ? ir(e) : e.length;
				var t = K(e);
				return t == le || t == S ? e.size : qi(e).length;
			}
			function ml(e, t, r) {
				var i = q(e) ? xn : va;
				return r && Yo(e, t, r) && (t = n), i(e, G(t, 3));
			}
			var hl = W(function(e, t) {
				if (e == null) return [];
				var n = t.length;
				return n > 1 && Yo(e, t[0], t[1]) ? t = [] : n > 2 && Yo(t[0], t[1], t[2]) && (t = [t[0]]), na(e, U(t, 1), []);
			}), gl = Pt || function() {
				return L.Date.now();
			};
			function _l(e, t) {
				if (typeof t != "function") throw new O(r);
				return e = Z(e), function() {
					if (--e < 1) return t.apply(this, arguments);
				};
			}
			function vl(e, t, r) {
				return t = r ? n : t, t = e && t == null ? e.length : t, xo(e, f, n, n, n, n, t);
			}
			function yl(e, t) {
				var i;
				if (typeof t != "function") throw new O(r);
			...
			function Sl(e, t, r) {
				...
				return i.placeholder = Sl.placeholder, i;
			}
			function Cl(e, t, r) {
				t = r ? n : t;
			...
			function wl(e, t, i) {
				...
				if (typeof e != "function") throw new O(r);
				t = Nu(t) || 0, Y(i) && (f = !!i.leading, p = "maxWait" in i, s = p ? N(Nu(i.maxWait) || 0, t) : s, m = "trailing" in i ? !!i.trailing : m);
				function h(t) {
					var r = a, i = o;
				...
				function te() {
					...
					if (a = arguments, o = this, u = e, r) {
						if (l === n) return g(u);
						if (p) return Ia(l), l = ps(y, t), h(u);
					}
					return l === n && (l = ps(y, t)), c;
				}
				return te.cancel = x, te.flush = ee, te;
			}
			var Tl = W(function(e, t) {
				return fi(e, 1, t);
			}), El = W(function(e, t, n) {
				return fi(e, Nu(t) || 0, n);
			});
			function Dl(e) {
				return xo(e, m);
			}
			function Ol(e, t) {
				if (typeof e != "function" || t != null && typeof t != "function") throw new O(r);
				var n = function() {
				...
				return n.cache = new (Ol.Cache || Fr)(), n;
			}
			Ol.Cache = Fr;
			function kl(e) {
				if (typeof e != "function") throw new O(r);
			...
			var jl = Pa(function(e, t) {
				t = t.length == 1 && q(t[0]) ? z(t[0], zn(G())) : z(U(t, 1), zn(G()));
				var n = t.length;
				return W(function(r) {
					for (var i = -1, a = I(r.length, n); ++i < a;) r[i] = t[i].call(this, r[i]);
					return un(e, this, r);
				});
			}), Ml = W(function(e, t) {
				return xo(e, u, n, t, B(t, No(Ml)));
			}), Nl = W(function(e, t) {
				return xo(e, d, n, t, B(t, No(Nl)));
			}), Pl = Oo(function(e, t) {
				return xo(e, p, n, n, n, t);
			});
			function Fl(e, t) {
				if (typeof e != "function") throw new O(r);
			...
			function Il(e, t) {
				if (typeof e != "function") throw new O(r);
				return t = t == null ? 0 : N(Z(t), 0), W(function(n) {
					var r = n[t], i = Fa(n, 0, t);
					return r && vn(i, r), un(e, this, i);
				});
			}
			function Ll(e, t, n) {
				var i = !0, a = !0;
				if (typeof e != "function") throw new O(r);
				return Y(n) && (i = "leading" in n ? !!n.leading : i, a = "trailing" in n ? !!n.trailing : a), wl(e, t, {
					leading: i,
					maxWait: t,
					trailing: a
				});
			...
			function Hl(e, t) {
				return t = typeof t == "function" ? t : n, li(e, 4, t);
			}
			function Ul(e) {
				return li(e, 5);
			}
			function Wl(e, t) {
				return t = typeof t == "function" ? t : n, li(e, 5, t);
			}
			function Gl(e, t) {
				return t == null || di(e, t, $(t));
			}
			function Kl(e, t) {
				return e === t || e !== e && t !== t;
			}
			var ql = go(Oi), Jl = go(function(e, t) {
				return e >= t;
			}), Yl = Fi(function() {
				return arguments;
			}()) ? Fi : function(e) {
				return X(e) && k.call(e, "callee") && !kt.call(e, "callee");
			}, q = T.isArray, Xl = rn ? zn(rn) : Ii;
			function Zl(e) {
				return e != null && lu(e.length) && !su(e);
			}
			function J(e) {
				return X(e) && Zl(e);
			}
			function Ql(e) {
				return e === !0 || e === !1 || X(e) && Di(e) == re;
			}
			var $l = Rt || Af, eu = an ? zn(an) : Li;
			function tu(e) {
				return X(e) && e.nodeType === 1 && !vu(e);
			}
			function nu(e) {
				if (e == null) return !0;
				if (Zl(e) && (q(e) || typeof e == "string" || typeof e.splice == "function" || $l(e) || wu(e) || Yl(e))) return !e.length;
				var t = K(e);
				if (t == le || t == S) return !e.size;
				if (ts(e)) return !qi(e).length;
			...
			function iu(e, t, r) {
				...
				var i = r ? r(e, t) : n;
				return i === n ? Ri(e, t, n, r) : !!i;
			}
			function au(e) {
				if (!X(e)) return !1;
				var t = Di(e);
				return t == oe || t == ae || typeof e.message == "string" && typeof e.name == "string" && !vu(e);
			}
			function ou(e) {
				return typeof e == "number" && Vt(e);
			}
			function su(e) {
				if (!Y(e)) return !1;
				var t = Di(e);
				return t == se || t == ce || t == ne || t == me;
			}
			function cu(e) {
			...
			var uu = on ? zn(on) : Bi;
			function du(e, t) {
				return e === t || Vi(e, t, Fo(t));
			}
			function fu(e, t, r) {
				return r = typeof r == "function" ? r : n, Vi(e, t, Fo(t), r);
			}
			function pu(e) {
				return _u(e) && e != +e;
			}
			function mu(e) {
				if (es(e)) throw new st("Unsupported core-js use. Try https://npms.io/search?q=ponyfill.");
				return Hi(e);
			}
			function hu(e) {
				return e === null;
			...
			function _u(e) {
				return typeof e == "number" || X(e) && Di(e) == ue;
			}
			function vu(e) {
				if (!X(e) || Di(e) != fe) return !1;
				var t = Dt(e);
				if (t === null) return !0;
				var n = k.call(t, "constructor") && t.constructor;
				return typeof n == "function" && n instanceof n && gt.call(n) == bt;
			}
			var yu = sn ? zn(sn) : Ui;
			function bu(e) {
				return cu(e) && e >= -9007199254740991 && e <= g;
			}
			var xu = cn ? zn(cn) : Wi;
			function Su(e) {
				return typeof e == "string" || !q(e) && X(e) && Di(e) == ge;
			}
			function Cu(e) {
				return typeof e == "symbol" || X(e) && Di(e) == _e;
			}
			var wu = ln ? zn(ln) : Gi;
			function Tu(e) {
				return e === n;
			...
			var Ou = go(Yi), ku = go(function(e, t) {
				return e <= t;
			});
			function Au(e) {
				if (!e) return [];
				if (Zl(e)) return Su(e) ? ar(e) : qa(e);
				if (Mt && e[Mt]) return Zn(e[Mt]());
				var t = K(e);
				return (t == le ? Qn : t == S ? er : Sd)(e);
			}
			function ju(e) {
				return e ? (e = Nu(e), e === h || e === -Infinity ? (e < 0 ? -1 : 1) * 17976931348623157e292 : e === e ? e : 0) : e === 0 ? e : 0;
			}
			function Z(e) {
				var t = ju(e), n = t % 1;
			...
			function Nu(e) {
				...
				e = Rn(e);
				var n = et.test(e);
				return n || nt.test(e) ? Xt(e.slice(2), n ? 2 : 8) : $e.test(e) ? _ : +e;
			}
			function Pu(e) {
				return Ja(e, id(e));
			}
			function Fu(e) {
				return e ? ci(Z(e), -9007199254740991, g) : e === 0 ? e : 0;
			}
			function Q(e) {
				return e == null ? "" : Ca(e);
			}
			var Iu = Qa(function(e, t) {
				if (ts(t) || Zl(t)) {
					Ja(t, $(t), e);
					return;
				}
				...
				Ja(t, id(t), e);
			}), Ru = Qa(function(e, t, n, r) {
				Ja(t, id(t), e, r);
			}), zu = Qa(function(e, t, n, r) {
				Ja(t, $(t), e, r);
			}), Bu = Oo(si);
			function Vu(e, t) {
				var n = _r(e);
				return t == null ? n : ii(n, t);
			}
			var Hu = W(function(e, t) {
				e = D(e);
				var r = -1, i = t.length, a = i > 2 ? t[2] : n;
				for (a && Yo(t[0], t[1], a) && (i = 1); ++r < i;) for (var o = t[r], s = id(o), c = -1, l = s.length; ++c < l;) {
					var u = s[c], d = e[u];
					(d === n || Kl(d, mt[u]) && !k.call(e, u)) && (e[u] = o[u]);
				}
				return e;
			}), Uu = W(function(e) {
				return e.push(n, Co), un(cd, n, e);
			});
			function Wu(e, t) {
				return Tn(e, G(t, 3), Si);
			}
			function Gu(e, t) {
				return Tn(e, G(t, 3), Ci);
			}
			function Ku(e, t) {
				return e == null ? e : bi(e, G(t, 3), id);
			}
			function qu(e, t) {
				return e == null ? e : xi(e, G(t, 3), id);
			}
			function Ju(e, t) {
				return e && Si(e, G(t, 3));
			}
			...
			function Zu(e) {
				return e == null ? [] : wi(e, id(e));
			}
			function Qu(e, t, r) {
				var i = e == null ? n : Ti(e, t);
				return i === n ? r : i;
			}
			function $u(e, t) {
				return e != null && Ho(e, t, ki);
			}
			function ed(e, t) {
				return e != null && Ho(e, t, Ai);
			}
			var td = lo(function(e, t, n) {
				t != null && typeof t.toString != "function" && (t = yt.call(t)), e[t] = n;
			}, cf(ff)), nd = lo(function(e, t, n) {
				t != null && typeof t.toString != "function" && (t = yt.call(t)), k.call(e, t) ? e[t].push(n) : e[t] = [n];
			}, G), rd = W(Pi);
			function $(e) {
				return Zl(e) ? Xr(e) : qi(e);
			}
			function id(e) {
				return Zl(e) ? Xr(e, !0) : Ji(e);
			}
			function ad(e, t) {
				var n = {};
				return t = G(t, 3), Si(e, function(e, r, i) {
					oi(n, t(e, r, i), e);
				}), n;
			}
			function od(e, t) {
			...
			var sd = Qa(function(e, t, n) {
				$i(e, t, n);
			}), cd = Qa(function(e, t, n, r) {
				$i(e, t, n, r);
			}), ld = Oo(function(e, t) {
				var n = {};
				if (e == null) return n;
				var r = !1;
				t = z(t, function(t) {
					return t = Na(t, e), r ||= t.length > 1, t;
				}), Ja(e, Ao(e), n), r && (n = li(n, 7, wo));
				for (var i = t.length; i--;) Ta(n, t[i]);
				return n;
			});
			function ud(e, t) {
				return fd(e, kl(G(t)));
			}
			var dd = Oo(function(e, t) {
				return e == null ? {} : ra(e, t);
			});
			function fd(e, t) {
				if (e == null) return {};
				var n = z(Ao(e), function(e) {
					return [e];
				});
				return t = G(t), ia(e, n, function(e, n) {
					return t(e, n[0]);
				});
			}
			function pd(e, t, r) {
				...
				var i = -1, a = t.length;
				for (a || (a = 1, e = n); ++i < a;) {
					var o = e == null ? n : e[ys(t[i])];
					o === n && (i = a, o = r), e = su(o) ? o.call(e) : o;
				}
				return e;
			}
			function md(e, t, n) {
				return e == null ? e : pa(e, t, n);
			}
			function hd(e, t, r, i) {
				return i = typeof i == "function" ? i : n, e == null ? e : pa(e, t, r, i);
			}
			var gd = bo($), _d = bo(id);
			function vd(e, t, n) {
				var r = q(e), i = r || $l(e) || wu(e);
				if (t = G(t, 4), n == null) {
					var a = e && e.constructor;
					n = i ? r ? new a() : [] : Y(e) && su(a) ? _r(Dt(e)) : {};
				}
				return (i ? fn : Si)(e, function(e, r, i) {
					return t(n, e, r, i);
				}), n;
			}
			function yd(e, t) {
			...
			function bd(e, t, n) {
				return e == null ? e : Ea(e, t, Ma(n));
			}
			function xd(e, t, r, i) {
				return i = typeof i == "function" ? i : n, e == null ? e : Ea(e, t, Ma(r), i);
			}
			function Sd(e) {
				return e == null ? [] : Bn(e, $(e));
			}
			function Cd(e) {
				return e == null ? [] : Bn(e, id(e));
			}
			function wd(e, t, r) {
				return r === n && (r = t, t = n), r !== n && (r = Nu(r), r = r === r ? r : 0), t !== n && (t = Nu(t), t = t === t ? t : 0), ci(Nu(e), t, r);
			}
			function Td(e, t, r) {
				return t = ju(t), r === n ? (r = t, t = 0) : r = ju(r), e = Nu(e), ji(e, t, r);
			}
			function Ed(e, t, r) {
				if (r && typeof r != "boolean" && Yo(e, t, r) && (t = r = n), r === n && (typeof t == "boolean" ? (r = t, t = n) : typeof e == "boolean" && (r = e, e = n)), e === n && t === n ? (e = 0, t = 1) : (e = ju(e), t === n ? (t = e, e = 0) : t = ju(t)), e > t) {
					var i = e;
					e = t, t = i;
				}
				if (r || e % 1 || t % 1) {
					var a = Jt();
					return I(e + a * (t - e + Yt("1e-" + ((a + "").length - 1))), t);
				}
				return ca(e, t);
			}
			var Dd = ro(function(e, t, n) {
				return t = t.toLowerCase(), e + (n ? Od(t) : t);
			});
			function Od(e) {
				return tf(Q(e).toLowerCase());
			}
			function kd(e) {
				return e = Q(e), e && e.replace(it, Gn).replace(Bt, "");
			}
			function Ad(e, t, r) {
				e = Q(e), t = Ca(t);
				var i = e.length;
			...
			function jd(e) {
				return e = Q(e), e && Ie.test(e) ? e.replace(Pe, Kn) : e;
			}
			function Md(e) {
				return e = Q(e), e && We.test(e) ? e.replace(Ue, "\\$&") : e;
			}
			var Nd = ro(function(e, t, n) {
				return e + (n ? "-" : "") + t.toLowerCase();
			}), Pd = ro(function(e, t, n) {
				return e + (n ? " " : "") + t.toLowerCase();
			}), Fd = no("toLowerCase");
			function Id(e, t, n) {
				e = Q(e), t = Z(t);
			...
			function zd(e, t, n) {
				return n || t == null ? t = 0 : t &&= +t, qt(Q(e).replace(Ge, ""), t || 0);
			}
			function Bd(e, t, r) {
				return t = (r ? Yo(e, t, r) : t === n) ? 1 : Z(t), ua(Q(e), t);
			}
			function Vd() {
				var e = arguments, t = Q(e[0]);
				return e.length < 3 ? t : t.replace(e[1], e[2]);
			}
			var Hd = ro(function(e, t, n) {
				return e + (n ? "_" : "") + t.toLowerCase();
			});
			function Ud(e, t, r) {
				return r && typeof r != "number" && Yo(e, t, r) && (t = r = n), r = r === n ? v : r >>> 0, r ? (e = Q(e), e && (typeof t == "string" || t != null && !yu(t)) && (t = Ca(t), !t && Yn(e)) ? Fa(ar(e), 0, r) : e.split(t, r)) : [];
			}
			var Wd = ro(function(e, t, n) {
				return e + (n ? " " : "") + tf(t);
			});
			function Gd(e, t, n) {
				return e = Q(e), n = n == null ? 0 : ci(Z(n), 0, e.length), t = Ca(t), e.slice(n, n + t.length) == t;
			}
			function Kd(e, t, r) {
				var i = V.templateSettings;
				r && Yo(e, t, r) && (t = n), e = Q(e), t = zu({}, t, i, So);
				var a = zu({}, t.imports, i.imports, So), o = $(a), s = Bn(a, o);
				fn(o, function(e) {
					if (E.test(e)) throw new st("Invalid `imports` option passed into `_.template`");
				});
				var c, l, u = 0, d = t.interpolate || at, f = "__p += '", p = ut((t.escape || at).source + "|" + d.source + "|" + (d === ze ? Ze : at).source + "|" + (t.evaluate || at).source + "|$", "g"), m = "//# sourceURL=" + (k.call(t, "sourceURL") ? (t.sourceURL + "").replace(/\s/g, " ") : "lodash.templateSources[" + ++Gt + "]") + "\n";
				e.replace(p, function(t, n, r, i, a, o) {
					return r ||= i, f += e.slice(u, o).replace(ot, qn), n && (c = !0, f += "' +\n__e(" + n + ") +\n'"), a && (l = !0, f += "';\n" + a + ";\n__p += '"), r && (f += "' +\n((__t = (" + r + ")) == null ? '' : __t) +\n'"), u = o + t.length, t;
				}), f += "';\n";
				var h = k.call(t, "variable") && t.variable;
				if (!h) f = "with (obj) {\n" + f + "\n}\n";
				else if (E.test(h)) throw new st("Invalid `variable` option passed into `_.template`");
				f = (l ? f.replace(Ae, "") : f).replace(je, "$1").replace(Me, "$1;"), f = "function(" + (h || "obj") + ") {\n" + (h ? "" : "obj || (obj = {});\n") + "var __t, __p = ''" + (c ? ", __e = _.escape" : "") + (l ? ", __j = Array.prototype.join;\nfunction print() { __p += __j.call(arguments, '') }\n" : ";\n") + f + "return __p\n}";
				var g = rf(function() {
					return ct(o, m + "return " + f).apply(n, s);
				});
			...
			function Yd(e, t, r) {
				if (e = Q(e), e && (r || t === n)) return Rn(e);
				if (!e || !(t = Ca(t))) return e;
				var i = ar(e), a = ar(t);
				return Fa(i, Hn(i, a), Un(i, a) + 1).join("");
			}
			function Xd(e, t, r) {
				if (e = Q(e), e && (r || t === n)) return e.slice(0, or(e) + 1);
				if (!e || !(t = Ca(t))) return e;
				var i = ar(e);
				return Fa(i, 0, Un(i, ar(t)) + 1).join("");
			}
			function Zd(e, t, r) {
				if (e = Q(e), e && (r || t === n)) return e.replace(Ge, "");
				if (!e || !(t = Ca(t))) return e;
				var i = ar(e);
				return Fa(i, Hn(i, ar(t))).join("");
			}
			function Qd(e, t) {
				var r = 30, i = "...";
				if (Y(t)) {
					var a = "separator" in t ? t.separator : a;
					r = "length" in t ? Z(t.length) : r, i = "omission" in t ? Ca(t.omission) : i;
				}
				e = Q(e);
				var o = e.length;
				if (Yn(e)) {
				...
				var c = r - ir(i);
				if (c < 1) return i;
				var l = s ? Fa(s, 0, c).join("") : e.slice(0, c);
				if (a === n) return l + i;
				if (s && (c += l.length - c), yu(a)) {
					if (e.slice(c).search(a)) {
						var u, d = l;
						for (a.global || (a = ut(a.source, Q(Qe.exec(a)) + "g")), a.lastIndex = 0; u = a.exec(d);) var f = u.index;
						l = l.slice(0, f === n ? c : f);
					}
				} else if (e.indexOf(Ca(a), c) != c) {
			...
			function $d(e) {
				return e = Q(e), e && Fe.test(e) ? e.replace(Ne, sr) : e;
			}
			var ef = ro(function(e, t, n) {
				return e + (n ? " " : "") + t.toUpperCase();
			}), tf = no("toUpperCase");
			function nf(e, t, r) {
				return e = Q(e), t = r ? n : t, t === n ? Xn(e) ? ur(e) : wn(e) : e.match(t) || [];
			}
			var rf = W(function(e, t) {
				try {
					return un(e, n, t);
				} catch (e) {
					return au(e) ? e : new st(e);
				}
			}), af = Oo(function(e, t) {
				return fn(t, function(t) {
					t = ys(t), oi(e, t, bl(e[t], e));
				}), e;
			});
			function of(e) {
				var t = e == null ? 0 : e.length, n = G();
				return e = t ? z(e, function(e) {
					if (typeof e[1] != "function") throw new O(r);
					return [n(e[0]), e[1]];
				}) : [], W(function(n) {
					for (var r = -1; ++r < t;) {
						var i = e[r];
						if (un(i[0], this, n)) return un(i[1], this, n);
					}
				});
			}
			function sf(e) {
			...
			function pf(e) {
				return Ki(typeof e == "function" ? e : li(e, 1));
			}
			function mf(e) {
				return Zi(li(e, 1));
			}
			...
			function vf(e, t, n) {
				var r = $(t), i = wi(t, r);
				n == null && !(Y(t) && (i.length || !r.length)) && (n = t, t = e, e = this, i = wi(t, $(t)));
				var a = !(Y(n) && "chain" in n) || !!n.chain, o = su(e);
				return fn(i, function(n) {
					...
					e[n] = r, o && (e.prototype[n] = function() {
						...
						if (a || t) {
							...
							return (n.__actions__ = qa(this.__actions__)).push({
								func: r,
								args: arguments,
								thisArg: e
							}), n.__chain__ = t, n;
			...
			var Sf = fo(z), Cf = fo(mn), wf = fo(xn);
			function Tf(e) {
				return Xo(e) ? jn(ys(e)) : aa(e);
			}
			function Ef(e) {
				return function(t) {
					return e == null ? n : Ti(e, t);
				};
			}
			var Df = ho(), Of = ho(!0);
			function kf() {
			...
			function Ff(e) {
				return q(e) ? z(e, ys) : Cu(e) ? [e] : qa(vs(Q(e)));
			}
			function If(e) {
				var t = ++_t;
				return Q(e) + t;
			}
			var Lf = uo(function(e, t) {
				return e + t;
			}, 0), Rf = vo("ceil"), zf = uo(function(e, t) {
				return e / t;
			}, 1), Bf = vo("floor");
			function Vf(e) {
				return e && e.length ? _i(e, ff, Oi) : n;
			}
			function Hf(e, t) {
				return e && e.length ? _i(e, G(t, 2), Oi) : n;
			}
			function Uf(e) {
				return An(e, ff);
			}
			...
			return V.after = _l, V.ary = vl, V.assign = Iu, V.assignIn = Lu, V.assignInWith = Ru, V.assignWith = zu, V.at = Bu, V.before = yl, V.bind = bl, V.bindAll = af, V.bindKey = xl, V.castArray = Bl, V.chain = Nc, V.chunk = Cs, V.compact = ws, V.concat = Ts, V.cond = of, V.conforms = sf, V.constant = cf, V.countBy = Wc, V.create = Vu, V.curry = Sl, V.curryRight = Cl, V.debounce = wl, V.defaults = Hu, V.defaultsDeep = Uu, V.defer = Tl, V.delay = El, V.difference = Es, V.differenceBy = Ds, V.differenceWith = Os, V.drop = ks, V.dropRight = As, V.dropRightWhile = js, V.dropWhile = Ms, V.fill = Ns, V.filter = Kc, V.flatMap = Yc, V.flatMapDeep = Xc, V.flatMapDepth = Zc, V.flatten = Is, V.flattenDeep = Ls, V.flattenDepth = Rs, V.flip = Dl, V.flow = uf, V.flowRight = df, V.fromPairs = zs, V.functions = Xu, V.functionsIn = Zu, V.groupBy = el, V.initial = Hs, V.intersection = Us, V.intersectionBy = Ws, V.intersectionWith = Gs, V.invert = td, V.invertBy = nd, V.invokeMap = nl, V.iteratee = pf, V.keyBy = rl, V.keys = $, V.keysIn = id, V.map = il, V.mapKeys = ad, V.mapValues = od, V.matches = mf, V.matchesProperty = hf, V.memoize = Ol, V.merge = sd, V.mergeWith = cd, V.method = gf, V.methodOf = _f, V.mixin = vf, V.negate = kl, V.nthArg = xf, V.omit = ld, V.omitBy = ud, V.once = Al, V.orderBy = al, V.over = Sf, V.overArgs = jl, V.overEvery = Cf, V.overSome = wf, V.partial = Ml, V.partialRight = Nl, V.partition = ol, V.pick = dd, V.pickBy = fd, V.property = Tf, V.propertyOf = Ef, V.pull = Xs, V.pullAll = Zs, V.pullAllBy = Qs, V.pullAllWith = $s, V.pullAt = ec, V.range = Df, V.rangeRight = Of, V.rearg = Pl, V.reject = ll, V.remove = tc, V.rest = Fl, V.reverse = nc, V.sampleSize = dl, V.set = md, V.setWith = hd, V.shuffle = fl, V.slice = rc, V.sortBy = hl, V.sortedUniq = uc, V.sortedUniqBy = dc, V.split = Ud, V.spread = Il, V.tail = fc, V.take = pc, V.takeRight = mc, V.takeRightWhile = hc, V.takeWhile = gc, V.tap = Pc, V.throttle = Ll, V.thru = Fc, V.toArray = Au, V.toPairs = gd, V.toPairsIn = _d, V.toPath = Ff, V.toPlainObject = Pu, V.transform = vd, V.unary = Rl, V.union = _c, V.unionBy = vc, V.unionWith = yc, V.uniq = bc, V.uniqBy = xc, V.uniqWith = Sc, V.unset = yd, V.unzip = Cc, V.unzipWith = wc, V.update = bd, V.updateWith = xd, V.values = Sd, V.valuesIn = Cd, V.without = Tc, V.words = nf, V.wrap = zl, V.xor = Ec, V.xorBy = Dc, V.xorWith = Oc, V.zip = kc, V.zipObject = Ac, V.zipObjectDeep = jc, V.zipWith = Mc, V.entries = gd, V.entriesIn = _d, V.extend = Lu, V.extendWith = Ru, vf(V, V), V.add = Lf, V.attempt = rf, V.camelCase = Dd, V.capitalize = Od, V.ceil = Rf, V.clamp = wd, V.clone = Vl, V.cloneDeep = Ul, V.cloneDeepWith = Wl, V.cloneWith = Hl, V.conformsTo = Gl, V.deburr = kd, V.defaultTo = lf, V.divide = zf, V.endsWith = Ad, V.eq = Kl, V.escape = jd, V.escapeRegExp = Md, V.every = Gc, V.find = qc, V.findIndex = Ps, V.findKey = Wu, V.findLast = Jc, V.findLastIndex = Fs, V.findLastKey = Gu, V.floor = Bf, V.forEach = Qc, V.forEachRight = $c, V.forIn = Ku, V.forInRight = qu, V.forOwn = Ju, V.forOwnRight = Yu, V.get = Qu, V.gt = ql, V.gte = Jl, V.has = $u, V.hasIn = ed, V.head = Bs, V.identity = ff, V.includes = tl, V.indexOf = Vs, V.inRange = Td, V.invoke = rd, V.isArguments = Yl, V.isArray = q, V.isArrayBuffer = Xl, V.isArrayLike = Zl, V.isArrayLikeObject = J, V.isBoolean = Ql, V.isBuffer = $l, V.isDate = eu, V.isElement = tu, V.isEmpty = nu, V.isEqual = ru, V.isEqualWith = iu, V.isError = au, V.isFinite = ou, V.isFunction = su, V.isInteger = cu, V.isLength = lu, V.isMap = uu, V.isMatch = du, V.isMatchWith = fu, V.isNaN = pu, V.isNative = mu, V.isNil = gu, V.isNull = hu, V.isNumber = _u, V.isObject = Y, V.isObjectLike = X, V.isPlainObject = vu, V.isRegExp = yu, V.isSafeInteger = bu, V.isSet = xu, V.isString = Su, V.isSymbol = Cu, V.isTypedArray = wu, V.isUndefined = Tu, V.isWeakMap = Eu, V.isWeakSet = Du, V.join = Ks, V.kebabCase = Nd, V.last = qs, V.lastIndexOf = Js, V.lowerCase = Pd, V.lowerFirst = Fd, V.lt = Ou, V.lte = ku, V.max = Vf, V.maxBy = Hf, V.mean = Uf, V.meanBy = Wf, V.min = Gf, V.minBy = Kf, V.stubArray = kf, V.stubFalse = Af, V.stubObject = jf, V.stubString = Mf, V.stubTrue = Nf, V.multiply = qf, V.nth = Ys, V.noConflict = yf, V.noop = bf, V.now = gl, V.pad = Id, V.padEnd = Ld, V.padStart = Rd, V.parseInt = zd, V.random = Ed, V.reduce = sl, V.reduceRight = cl, V.repeat = Bd, V.replace = Vd, V.result = pd, V.round = Jf, V.runInContext = e, V.sample = ul, V.size = pl, V.snakeCase = Hd, V.some = ml, V.sortedIndex = ic, V.sortedIndexBy = ac, V.sortedIndexOf = oc, V.sortedLastIndex = sc, V.sortedLastIndexBy = cc, V.sortedLastIndexOf = lc, V.startCase = Wd, V.startsWith = Gd, V.subtract = Yf, V.sum = Xf, V.sumBy = Zf, V.template = Kd, V.times = Pf, V.toFinite = ju, V.toInteger = Z, V.toLength = Mu, V.toLower = qd, V.toNumber = Nu, V.toSafeInteger = Fu, V.toString = Q, V.toUpper = Jd, V.trim = Yd, V.trimEnd = Xd, V.trimStart = Zd, V.truncate = Qd, V.unescape = $d, V.uniqueId = If, V.upperCase = ef, V.upperFirst = tf, V.each = Qc, V.eachRight = $c, V.first = Bs, vf(V, function() {
				...
				H.prototype[e] = function(r) {
					...
					return i.__filtered__ ? i.__takeCount__ = I(r, i.__takeCount__) : i.__views__.push({
						size: I(r, v),
				...
				a && (V.prototype[t] = function() {
					var t = this.__wrapped__, s = i ? [1] : arguments, c = t instanceof H, l = s[0], u = c || q(t), d = function(e) {
						var t = a.apply(V, vn([e], s));
						return i && f ? t[0] : t;
					};
				...
				var t = ft[e], n = /^(?:push|sort|unshift)$/.test(e) ? "tap" : "thru", r = /^(?:pop|shift)$/.test(e);
				...
				name: "wrapper",
				func: n
			}], H.prototype.clone = br, H.prototype.reverse = xr, H.prototype.value = Sr, V.prototype.at = Ic, V.prototype.chain = Lc, V.prototype.commit = Rc, V.prototype.next = zc, V.prototype.plant = Vc, V.prototype.reverse = Hc, V.prototype.toJSON = V.prototype.valueOf = V.prototype.value = Uc, V.prototype.first = V.prototype.head, Mt && (V.prototype[Mt] = Bc), V;
		})();
		typeof define == "function" && typeof define.amd == "object" && define.amd ? (L._ = dr, define(function() {
			return dr;
		})) : en ? ((en.exports = dr)._ = dr, $t._ = dr) : L._ = dr;
	}).call(e);
})), d = /* @__PURE__ */ o(((e, t) => {
	var n = (/* @__PURE__ */ c(u())).default;
	t.exports = {
		clone: n.clone,
		constant: n.constant,
		each: n.each,
	...
	var r = "\0", i = "\0", a = "";
	function o(e) {
		this._isDirected = !n.has(e, "directed") || e.directed, this._isMultigraph = n.has(e, "multigraph") ? e.multigraph : !1, this._isCompound = n.has(e, "compound") ? e.compound : !1, this._label = void 0, this._defaultNodeLabelFn = n.constant(void 0), this._defaultEdgeLabelFn = n.constant(void 0), this._nodes = {}, this._isCompound && (this._parent = {}, this._children = {}, this._children[i] = {}), this._in = {}, this._preds = {}, this._out = {}, this._sucs = {}, this._edgeObjs = {}, this._edgeLabels = {};
	}
	o.prototype._nodeCount = 0, o.prototype._edgeCount = 0, o.prototype.isDirected = function() {
		...
		var r = arguments.length === 1 ? f(this._isDirected, arguments[0]) : l(this._isDirected, e, t, n);
		return this._edgeLabels[r];
	}, o.prototype.hasEdge = function(e, t, r) {
		var i = arguments.length === 1 ? f(this._isDirected, arguments[0]) : l(this._isDirected, e, t, r);
		return n.has(this._edgeLabels, i);
	}, o.prototype.removeEdge = function(e, t, n) {
		var r = arguments.length === 1 ? f(this._isDirected, arguments[0]) : l(this._isDirected, e, t, n), i = this._edgeObjs[r];
...
})), le = /* @__PURE__ */ c(u(), 1), ue = /* @__PURE__ */ c(ce(), 1);
function de() {
	return typeof window < "u" && (window._ || (window._ = le.default), window.graphlib || (window.graphlib = ue.default)), {
		_: le.default,
		graphlib: ue.default
	};
}
...
var fe = new class {
	...
	off(e, t) {
		this.listeners.has(e) && (this.listeners.get(e).delete(t), this.listeners.get(e).size === 0 && this.listeners.delete(e));
	}
	emit(e, t) {
		if (this.listeners.has(e)) for (let n of this.listeners.get(e)) try {
			n(t);
		} catch (t) {
			console.error(`Error in event listener for ${e}:`, t);
		}
		if (this.listeners.has("*")) for (let n of this.listeners.get("*")) try {
			n({
				event: e,
				payload: t
			});
	...
	constructor() {
		this.nodes = /* @__PURE__ */ new Map(), this.connections = [], this.listeners = /* @__PURE__ */ new Map();
	}
	on(e, t) {
		return this.listeners.has(e) || this.listeners.set(e, /* @__PURE__ */ new Set()), this.listeners.get(e).add(t), () => this.off(e, t);
	}
	...
	emit(e, t) {
		if (this.listeners.has(e)) for (let n of this.listeners.get(e)) n(t);
		fe.emit(e, {
			graph: this,
			...t
		});
	...
	clear() {
		this.nodes.clear(), this.connections = [], this.emit("graph:cleared", {});
	}
	createNode(e, t = {
		x: 100,
		y: 100
	}, n = "node_preset_1") {
		if (this.nodes.has(e)) return console.warn(`A node named "${e}" already exists.`), null;
		let r = {
			name: e,
			position: t,
			preset: n,
		...
		return this.nodes.set(e, r), this.emit("node:created", {
			nodeName: e,
			node: r
		}), r;
	}
	deleteNode(e) {
		...
		this.connections = this.connections.filter((t) => {
			let n = t.sourceNode === e || t.targetNode === e;
			return n && this.emit("connection:deleted", { connection: t }), !n;
		});
		let t = this.nodes.get(e);
		this.nodes.delete(e), this.emit("node:deleted", {
			nodeName: e,
			node: t
		});
	}
	renameNode(e, t) {
		...
		if (this.nodes.has(t)) return console.warn(`Node named "${t}" already exists.`), !1;
		let n = this.nodes.get(e);
		return n.name = t, this.nodes.set(t, n), this.nodes.delete(e), this.connections.forEach((n) => {
			n.sourceNode === e && (n.sourceNode = t), n.targetNode === e && (n.targetNode = t);
		}), this.emit("node:renamed", {
			oldName: e,
			newName: t,
			node: n
		}), !0;
	...
	moveNode(e, t) {
		if (!this.nodes.has(e)) return;
		let n = this.nodes.get(e);
		n.position = t, this.emit("node:moved", {
			nodeName: e,
			position: t
		});
	}
	updateNodeMetadata(e, t, n) {
		if (!this.nodes.has(e)) return;
	...
	createAttribute(e, t) {
		let n = this.nodes.get(e);
		if (!n) return null;
		let { name: r, plug: i = !1, socket: a = !1, preset: o = i ? "attr_preset_2" : "attr_preset_1", dataType: s = "Unknown", connectionIcon: c = null, connectionLabel: l = null, plugMaxConnections: u = -1, socketMaxConnections: d = 1 } = t;
		if (n.attributes.some((e) => e.name.toLowerCase() === r.toLowerCase() && !!(a && e.socket || i && e.plug || !a && !i && !e.socket && !e.plug))) return console.warn(`Attribute "${r}" already exists on node "${e}" on the same side.`), null;
		let f = {
			name: r,
			plug: i,
			socket: a,
			...
			connectionIcon: c,
			connectionLabel: l,
			plugMaxConnections: u,
			socketMaxConnections: d
		};
		n.attributes.push(f);
		let p = n.attributes.length - 1;
		return this.emit("attribute:created", {
			nodeName: e,
			attribute: f,
			index: p
		}), f;
	}
	deleteAttribute(e, t, n = null) {
		let r = this.nodes.get(e);
		if (!r) return;
		let i = -1;
		if (n === "socket" || n === "input" ? i = r.attributes.findIndex((e) => e.name === t && e.socket) : (n === "plug" || n === "output") && (i = r.attributes.findIndex((e) => e.name === t && e.plug)), i === -1 && (i = r.attributes.findIndex((e) => e.name === t)), i === -1) return;
		let a = r.attributes[i];
		this.connections = this.connections.filter((t) => {
			let n = a.plug && t.sourceNode === e && t.sourceAttr === a.name || a.socket && t.targetNode === e && t.targetAttr === a.name;
			return n && this.emit("connection:deleted", { connection: t }), !n;
		}), r.attributes.splice(i, 1), this.emit("attribute:deleted", {
			nodeName: e,
			attribute: a,
			index: i
		});
	...
	editAttribute(e, t, n) {
		let r = this.nodes.get(e);
		if (!r || !r.attributes[t]) return null;
		let i = r.attributes[t], a = i.name, o = n.name === void 0 ? a : n.name.trim(), s = n.socket === void 0 ? i.socket : n.socket, c = n.plug === void 0 ? i.plug : n.plug;
		return o && o.toLowerCase() !== a.toLowerCase() && r.attributes.some((e, n) => n === t || e.name.toLowerCase() !== o.toLowerCase() ? !1 : !!(s && e.socket || c && e.plug || !s && !c && !e.socket && !e.plug)) ? (console.warn(`Attribute "${o}" already exists on node "${e}" on the same side.`), null) : (r.attributes[t] = {
			...i,
			...n,
			name: o
		}, o !== a && this.connections.forEach((t) => {
			i.plug && t.sourceNode === e && t.sourceAttr === a && (t.sourceAttr = o), i.socket && t.targetNode === e && t.targetAttr === a && (t.targetAttr = o);
		}), this.emit("attribute:edited", {
			nodeName: e,
			index: t,
			oldAttr: i,
			newAttr: r.attributes[t]
		}), r.attributes[t]);
	}
	reorderAttribute(e, t, n) {
		let r = this.nodes.get(e);
		if (!r) return;
		let i = t + n;
		if (i < 0 || i >= r.attributes.length) return;
		let a = r.attributes[t];
		r.attributes[t] = r.attributes[i], r.attributes[i] = a, this.emit("attribute:reordered", {
			nodeName: e,
			fromIndex: t,
			toIndex: i
		});
	...
	createConnection(e, t, n, r) {
		if (this.connections.some((i) => i.sourceNode === e && i.sourceAttr === t && i.targetNode === n && i.targetAttr === r)) return null;
		let i = this.nodes.get(e), a = this.nodes.get(n);
		if (!i || !a) return null;
		let o = {
			sourceNode: e,
			sourceAttr: t,
		...
		return this.connections.push(o), this.emit("connection:created", { connection: o }), o;
	}
	deleteConnection(e, t, n, r) {
		let i = this.connections.length;
		return this.connections = this.connections.filter((i) => {
			let a = i.sourceNode === e && i.sourceAttr === t && i.targetNode === n && i.targetAttr === r;
			return a && this.emit("connection:deleted", { connection: i }), !a;
		}), this.connections.length < i;
	}
	evaluateGraph() {
		return this.connections.map((e) => [`${e.sourceNode}.${e.sourceAttr}`, `${e.targetNode}.${e.targetAttr}`]);
	}
	getIsolatedData(e) {
		let t = this.nodes.get(e);
		if (!t) return null;
		let n = {
			...
			inputs: {},
			outputs: {}
		}, r = this.connections.filter((t) => t.sourceNode === e || t.targetNode === e);
		return t.attributes.forEach((t) => {
			if (t.socket) {
				let i = r.filter((n) => n.targetNode === e && n.targetAttr === t.name).map((e) => [e.sourceNode, e.sourceAttr]);
				n.inputs[t.name] = {
					dataType: t.dataType,
					connectionIcon: t.connectionIcon,
					connections: i
				};
			}
			if (t.plug) {
				let i = r.filter((n) => n.sourceNode === e && n.sourceAttr === t.name).map((e) => [e.targetNode, e.targetAttr]);
				n.outputs[t.name] = {
					dataType: t.dataType,
					connectionIcon: t.connectionIcon,
					connections: i
...
}, me = [
	{
		...
		type: "AAF",
		extensions: ["aaf"],
		description: "Avid Advanced Authoring Format edit decision list",
		path: "/data_type_icons/aaf.svg"
	},
	{
		code: "alembic",
		type: "Alembic",
		extensions: ["abc"],
		description: "Alembic computer graphics interchange framework",
		path: "/data_type_icons/alembic.svg"
	},
	{
		code: "ale",
		type: "ALE",
		extensions: ["ale"],
		description: "Avid Log Exchange metadata format",
		path: "/data_type_icons/ale.svg"
	},
	{
		code: "atom",
		type: "Atom",
		extensions: ["atom"],
		description: "Atom parameter mapping format",
		path: "/data_type_icons/atom.svg"
	},
	{
		code: "blend",
		type: "BLEND",
		...
		path: "/data_type_icons/blend.svg"
	},
	{
		code: "bvh",
		type: "BVH",
		extensions: ["bvh"],
		description: "Biovision Hierarchy character animation format",
		path: "/data_type_icons/bvh.svg"
	},
	{
		code: "csv",
		type: "CSV",
	...
	},
	{
		...
		path: "/data_type_icons/exr.svg"
	},
	{
		code: "fbx",
		type: "FBX",
		extensions: ["fbx"],
		description: "Autodesk Filmbox interchange format",
		path: "/data_type_icons/fbx.svg"
	},
	{
		code: "fdx",
		type: "FDX",
		extensions: ["fdx"],
		description: "Final Draft XML screenplay document",
		path: "/data_type_icons/fdx.svg"
	},
	{
		code: "fountain",
		type: "FOUNTAIN",
		extensions: ["fountain"],
		description: "Fountain plain text screenplay markup format",
		path: "/data_type_icons/fountain.svg"
	},
	{
		code: "gizmo",
		type: "GIZMO",
		extensions: ["gizmo", "nk"],
		description: "Foundry Nuke Gizmo node script macro",
		path: "/data_type_icons/gizmo.svg"
	},
	{
		code: "gltf",
		type: "GLTF",
		...
		path: "/data_type_icons/gltf.svg"
	},
	{
		code: "grm",
		type: "GRM",
		extensions: ["grm"],
		description: "Yeti Groom hair and fur description file",
		path: "/data_type_icons/grm.svg"
	},
	{
		code: "gto",
		type: "GTO",
		extensions: ["gto"],
		description: "Production Kitchen Sink Computer Graphics File Format, OpenGTO",
		path: "/data_type_icons/gto.svg"
	},
	{
		code: "hda",
		type: "HDA",
		...
		description: "SideFX Houdini Digital Asset",
		path: "/data_type_icons/hda.svg"
	},
	{
		code: "hdr",
		type: "HDR",
		extensions: ["hdr", "pic"],
		description: "Radiance High Dynamic Range image format",
		path: "/data_type_icons/hdr.svg"
	},
	{
		code: "jpg",
		type: "JPG",
	...
	},
	{
		...
		path: "/data_type_icons/json.svg"
	},
	{
		code: "kiko",
		type: "KIKO",
		extensions: ["kiko"],
		description: "Kiko animation curves format",
		path: "/data_type_icons/kiko.svg"
	},
	{
		code: "materialx",
		type: "MaterialX",
		extensions: ["mtlx"],
		description: "Open standard for transfer of rich material and look-development content",
		path: "/data_type_icons/materialx.svg"
	},
	{
		code: "mayaascii",
		type: "MAYAASCII",
		extensions: ["ma"],
		description: "Autodesk Maya ASCII file format",
		path: "/data_type_icons/mayaascii.svg"
	},
	{
		code: "mayabin",
		type: "MAYABIN",
		extensions: ["mb"],
		description: "Autodesk Maya Binary file format",
		path: "/data_type_icons/mayabin.svg"
	},
	{
		code: "obj",
		type: "OBJ",
		extensions: ["obj"],
		description: "Wavefront 3D geometry definition file",
		path: "/data_type_icons/obj.svg"
	},
	{
		code: "openvdb",
		type: "OpenVDB",
		extensions: ["vdb"],
		description: "Sparse volume data representation",
		path: "/data_type_icons/openvdb.svg"
	},
	{
		code: "osl",
		type: "OSL",
		extensions: ["osl", "oso"],
		description: "Open Shading Language shader specification format",
		path: "/data_type_icons/osl.svg"
	},
	{
		code: "otio",
		type: "OTIO",
		...
		description: "OpenTimelineIO API and interchange format",
		path: "/data_type_icons/otio.svg"
	},
	{
		code: "partio",
		type: "PARTIO",
		...
		description: "Disney Partio particle cache format",
		path: "/data_type_icons/partio.svg"
	},
	{
		code: "pdf",
		type: "PDF",
		...
		path: "/data_type_icons/pdf.svg"
	},
	{
		code: "ply",
		type: "PLY",
		extensions: ["ply"],
		description: "Polygon File Format 3D mesh and point cloud",
		path: "/data_type_icons/ply.svg"
	},
	{
		code: "psd",
		type: "PSD",
		...
		path: "/data_type_icons/psd.svg"
	},
	{
		code: "ptex",
		type: "PTEX",
		extensions: ["ptx", "ptex"],
		description: "Per-Face Texture Mapping format",
		path: "/data_type_icons/ptex.svg"
	},
	{
		code: "review",
		type: "REVIEW",
		extensions: ["mov", "mp4"],
		description: "Pipeline movie review file",
		path: "/data_type_icons/review.svg"
	},
	{
		code: "rumba",
		type: "RUMBA",
		extensions: ["rumba"],
		description: "Rumba animation tool format",
		path: "/data_type_icons/rumba.svg"
	},
	{
		code: "screenjson",
		type: "SCREENJSON",
		extensions: ["screenjson"],
		description: "ScreenJson screenplay data format (screenjson.com)",
		path: "/data_type_icons/screenjson.svg"
	},
	{
		code: "splat",
		type: "SPLAT",
		extensions: ["splat"],
		description: "3D Gaussian Splatting point cloud format",
		path: "/data_type_icons/splat.svg"
	},
	{
		code: "uasset",
		type: "UASSET",
		extensions: ["uasset"],
		description: "Unreal Engine Asset binary package",
		path: "/data_type_icons/uasset.svg"
	},
	{
		code: "umap",
		type: "UMAP",
		extensions: ["umap"],
		description: "Unreal Engine Map level package",
		path: "/data_type_icons/umap.svg"
	},
	{
		code: "usd",
		type: "USD",
	...
	},
	{
		...
		path: "/data_type_icons/wav.svg"
	},
	{
		code: "xgen",
		type: "XGEN",
		extensions: ["xgen"],
		description: "Autodesk Maya XGen description file",
		path: "/data_type_icons/xgen.svg"
	},
	{
		code: "xml",
		type: "XML",
		...
		path: "/data_type_icons/xml.svg"
	}
];
//#endregion
//#region src/utils/content-hash.js
function he(e) {
	let t = 2166136261;
...
//#endregion
//#region src/utils/hexagon-badge-generator.js
function S({ code: e = "custom", label: t = "", color: n = "#38BDF8", logoXml: r = "" }) {
	let i = (e || "custom").toLowerCase().replace(/[^a-z0-9-_]/g, "_"), a = (t || e || "FORMAT").toUpperCase(), o = "7.2", s = "0.5";
	a.length <= 3 ? (o = "9.0", s = "0.4") : a.length === 4 ? (o = "8.2", s = "0.5") : a.length <= 7 ? (o = "7.2", s = "0.5") : (o = "6.5", s = "0.6");
	let c = (r || "").trim(), l = "";
	if (!c) l = `<circle cx="32" cy="25.5" r="7" fill="${n}" fill-opacity="0.25" stroke="${n}" stroke-width="1.8"/>`;
	else {
		let e = 0, t = 0, r = 24, i = 24, a = c, o = c.match(/<svg([^>]*)>(.*)<\/svg>/is);
		if (o) {
			let n = o[1];
			a = o[2];
			let s = n.match(/viewBox=["']([^"']+)["']/i);
			if (s) {
				let n = s[1].trim().split(/[\s,]+/).map(Number);
				n.length === 4 && !n.some(isNaN) && ([e, t, r, i] = n);
			} else {
				let e = n.match(/width=["']([^"']+)["']/i), t = n.match(/height=["']([^"']+)["']/i);
				e && t && (r = parseFloat(e[1]) || 24, i = parseFloat(t[1]) || 24);
			}
		} else c.startsWith("<") || (a = `<path d="${c}"/>`);
		let s = r > 0 ? r : 24, u = i > 0 ? i : 24, d = Math.min(23 / s, 22 / u), f = 32 - s * d / 2 - e * d, p = 25.5 - u * d / 2 - t * d;
		a = a.replace(/stroke=["']currentColor["']/gi, `stroke="${n}"`).replace(/fill=["']currentColor["']/gi, `fill="${n}"`);
		let m = c.includes("stroke="), h = m && !c.includes("fill=\"") ? "fill=\"none\"" : "", g = m ? `stroke="${n}"` : "";
		l = `<g transform="translate(${f.toFixed(2)}, ${p.toFixed(2)}) scale(${d.toFixed(4)})" ${h} ${g}>${a}</g>`;
	}
...
//#endregion
//#region src/core/custom-type-store.js
var ge = "plumber:custom-types";
function _e(e) {
	if (!e) return "";
	if (e.startsWith("data:image/svg+xml;base64,")) return e;
	if (e.startsWith("data:image/svg+xml")) try {
		let t = decodeURIComponent(e.split(",")[1] || "");
		if (t) return `data:image/svg+xml;base64,${btoa(unescape(encodeURIComponent(t)))}`;
	} catch {}
	return `data:image/svg+xml;base64,${btoa(unescape(encodeURIComponent(e)))}`;
}
var ve = new class {
	constructor() {
		this.customTypes = [], this.load();
	}
	load() {
		try {
			...
			if (e) {
				let t = JSON.parse(e);
				Array.isArray(t) ? this.customTypes = t.map((e) => {
					let t = e.iconPath || "";
					return t.startsWith("data:image/svg+xml") ? t.startsWith("data:image/svg+xml;utf8,") && (t = _e(t)) : t = _e(e.icon || S({
						code: e.code || "custom",
						label: (e.code || "CUSTOM").toUpperCase(),
						color: "#10B981"
					})), {
						...e,
			...
			} else this.customTypes = [];
		} catch (e) {
			console.warn("Recovering from invalid custom data types in localStorage:", e), this.customTypes = [];
		}
	}
	save() {
		try {
			localStorage.setItem(ge, JSON.stringify(this.customTypes));
		} catch (e) {
	...
	getType(e) {
		return e ? this.customTypes.find((t) => t.code.toLowerCase() === e.toLowerCase()) : null;
	}
	addType(e) {
		let { code: t, type: n, extensions: r = [], description: i = "", icon: a = "", iconPath: o = "" } = e, s = t.toLowerCase(), c = Array.isArray(r) ? r : [], l = _e(o || a || S({
			code: s,
			label: s.toUpperCase(),
			color: "#38BDF8"
		})), u = `sha256:${he(`${s}:${n}:${c.join(",")}:${l}`)}`, d = this.customTypes.findIndex((e) => e.code.toLowerCase() === s), f = {
			code: s,
			type: n,
			extensions: c,
			description: i,
		...
		return d === -1 ? this.customTypes.push(f) : this.customTypes[d] = f, this.save(), u;
	}
	removeType(e) {
		let t = e?.toLowerCase();
		t && (this.customTypes = this.customTypes.filter((e) => e.code.toLowerCase() !== t), this.save());
	}
	importTypes(e) {
		let t = {
			added: 0,
		...
		return Array.isArray(e) && e.forEach((e) => {
			...
			let n = e.code.toLowerCase(), r = this.getType(n);
			r ? r.hash === e.hash ? t.skipped++ : (this.addType(e), t.conflicts++) : (this.addType(e), t.added++);
		}), t;
	}
}();
//#endregion
//#region src/utils/asset-path.js
function ye(e) {
	if (!e) return "";
...
var be = {
	...
	resolveCode(e) {
		if (!e) return "";
		let t = e.toLowerCase();
		return this.extensionMap.get(t) || t;
	}
	registerDefaults() {
		me.forEach((e) => {
			let t = e.code.toLowerCase(), n = {
				code: e.code,
				type: e.type,
				extensions: e.extensions || [],
				description: e.description || "",
				iconPath: ye(`/data_type_icons/${e.code}.svg`),
				isCustom: !1
			};
			this.types.set(t, n), Array.isArray(e.extensions) && e.extensions.forEach((e) => {
				this.extensionMap.set(e.toLowerCase(), t);
			});
		}), ve.getTypes().forEach((e) => {
			let t = e.code.toLowerCase(), n = e.iconPath || "", r = {
				code: e.code,
				type: e.type,
				extensions: e.extensions || [],
				description: e.description || "",
			...
			this.types.set(t, r), Array.isArray(e.extensions) && e.extensions.forEach((e) => {
				this.extensionMap.set(e.toLowerCase(), t);
			}), n && this.loadImage(t, n);
		});
	}
	async initialize() {
		this.initialized || (this.initialized = !0, await this.preloadImages());
	}
	getAllTypes() {
		return Array.from(this.types.values()).sort((e, t) => e.code.localeCompare(t.code));
	}
	getType(e) {
		if (!e) return null;
		let t = this.resolveCode(e);
		return this.types.get(t) || null;
	}
	async preloadImages() {
		let e = [];
		for (let [t, n] of this.types.entries()) n.iconPath && e.push(this.loadImage(t, n.iconPath));
		await Promise.all(e), this.notifyLoaded();
	}
	loadImage(e, t) {
		let n = this.resolveCode(e);
		return !n || !t ? Promise.resolve(null) : new Promise((e) => {
			if (this.imageCaches.has(n) && this.dataUrlCaches.has(n)) {
				e(this.imageCaches.get(n));
				return;
			}
			if (t.startsWith("data:")) {
				this.dataUrlCaches.set(n, t);
				try {
					if (t.includes("base64,")) {
						let e = t.split("base64,")[1] || "", r = atob(e);
						r && r.includes("<svg") && this.svgTextCaches.set(n, r);
					} else {
						let e = decodeURIComponent(t.split(",")[1] || "");
						e && e.includes("<svg") && this.svgTextCaches.set(n, e);
					}
				} catch {}
				let r = new Image();
				r.src = t, r.onload = () => {
					this.imageCaches.set(n, r), this.notifyLoaded(), e(r);
				}, r.onerror = (t) => {
					console.warn(`Failed to load Data URI image for custom type ${n}:`, t), e(null);
				};
				return;
			}
			let r = typeof window < "u" && window.location && window.location.protocol === "file:", i = t.startsWith("http://") || t.startsWith("https://");
			if (!(!r && (i || t.startsWith("/")))) {
				this._applyVectorFallback(n, e);
				return;
			}
			fetch(t).then((e) => {
				...
				this.svgTextCaches.set(n, r);
				let i = `data:image/svg+xml;base64,${btoa(unescape(encodeURIComponent(r)))}`;
				this.dataUrlCaches.set(n, i);
				let a = new Image();
				a.src = i, a.onload = () => {
					this.imageCaches.set(n, a), this.notifyLoaded(), e(a);
				}, a.onerror = () => {
					let r = new Image();
					r.src = t, r.onload = () => {
						this.imageCaches.set(n, r), this.notifyLoaded(), e(r);
	...
	_applyVectorFallback(e, t) {
		let n = (this.inlineIcons ? this.inlineIcons[e] : null) || S({
			code: e,
			label: e.toUpperCase(),
			color: "#38BDF8"
		});
		...
		let i = new Image();
		i.src = r, i.onload = () => {
			this.imageCaches.set(e, i), this.notifyLoaded(), t(i);
		}, i.onerror = () => t(null);
	}
	getImage(e) {
		if (!e) return null;
		let t = this.resolveCode(e);
		if (this.imageCaches.has(t)) return this.imageCaches.get(t);
		let n = this.types.get(t);
		return n && n.iconPath && this.loadImage(t, n.iconPath), null;
	}
	getDataUrl(e) {
		if (!e) return null;
		let t = this.resolveCode(e);
		return this.dataUrlCaches.get(t) || null;
	}
	getSvgText(e) {
		if (!e) return null;
		let t = this.resolveCode(e);
		return this.svgTextCaches.get(t) || null;
	}
	onLoaded(e) {
		return this.onLoadedListeners.add(e), () => this.onLoadedListeners.delete(e);
	}
	notifyLoaded() {
		this.onLoadedListeners.forEach((e) => {
			try {
				e();
			} catch {}
		});
	}
	acceptsConnection(e, t) {
		return !e || !t ? !1 : this.resolveCode(e) === this.resolveCode(t);
	}
	addCustomType(e) {
		let t = ve.addType(e), n = ve.getType(e.code), r = this.resolveCode(e.code), i = n?.iconPath || e.iconPath || "", a = {
			code: n?.code || e.code,
			type: n?.type || e.type,
			extensions: n?.extensions || e.extensions || [],
			description: n?.description || e.description || "",
			iconPath: i,
			isCustom: !0,
			hash: t
		};
		return this.types.set(r, a), Array.isArray(a.extensions) && a.extensions.forEach((e) => {
			this.extensionMap.set(e.toLowerCase(), r);
		}), i && this.loadImage(r, i), t;
	}
	removeCustomType(e) {
		let t = this.resolveCode(e);
		if (t) {
			for (let [e, n] of this.extensionMap.entries()) n === t && this.extensionMap.delete(e);
			ve.removeType(t), this.types.delete(t), this.imageCaches.delete(t), this.dataUrlCaches.delete(t), this.svgTextCaches.delete(t);
		}
	}
}();
//#endregion
//#region src/core/graph-serializer.js
function Se(e, t) {
	try {
		let n = typeof e == "string" ? JSON.parse(e) : e;
		if (t.clear(), !n || typeof n != "object") throw Error("Invalid graph file format.");
		n.CUSTOM_TYPES && Array.isArray(n.CUSTOM_TYPES) && n.CUSTOM_TYPES.forEach((e) => {
			xe.addCustomType(e);
		});
		let r = n.NODES || {};
		for (let [e, n] of Object.entries(r)) {
			let r = n.position || [100, 100], i = {
				x: r[0],
				y: r[1]
			}, a = n.preset || "node_preset_1", o = t.createNode(e, i, a);
			o && (o.alternate = n.alternate === void 0 || n.alternate, o.metadata = n.metadata || { process_details: "" }, (n.attributes || []).forEach((n) => {
				let r = n.dataType || "Unknown";
				if (typeof r == "string" && r.includes("<class '")) {
					let e = r.match(/<class '__main__\.(\w+)'>/);
					if (e && e[1]) r = e[1].toLowerCase();
					else {
						let e = r.match(/'([^']+)'/);
						if (e && e[1]) {
							let t = e[1].split(".");
							r = t[t.length - 1].toLowerCase();
						}
					}
				} else typeof r == "string" && (r = r.toLowerCase());
				t.createAttribute(e, {
					name: n.name,
					plug: n.plug === void 0 || n.plug,
					socket: n.socket === void 0 || n.socket,
					preset: n.preset || (n.plug ? "attr_preset_2" : "attr_preset_1"),
					dataType: r,
					connectionIcon: n.connectionIcon || null,
					connectionLabel: n.connectionLabel || null,
					plugMaxConnections: n.plugMaxConnections === void 0 ? -1 : n.plugMaxConnections,
					socketMaxConnections: n.socketMaxConnections === void 0 ? 1 : n.socketMaxConnections
				});
			}));
		}
		return (n.CONNECTIONS || []).forEach((e) => {
			let n = e[0], r = e[1];
			if (n && r) {
				let [e, i] = n.split("."), [a, o] = r.split(".");
				e && i && a && o && t.createConnection(e, i, a, o);
			}
		}), t.emit("node:moved", {}), t.emit("graph:loaded", {}), !0;
	} catch (e) {
		return console.error("Failed to parse graph JSON:", e), !1;
	}
}
//#endregion
//#region node_modules/dagre/lib/graphlib.js
var Ce = /* @__PURE__ */ o(((e, t) => {
	var n;
	...
	var n = C(), r = ke(), i = Oe().slack, a = Oe().longestPath, o = Ce().alg.preorder, s = Ce().alg.postorder, c = w().simplify;
	...
	var n = Oe().longestPath, r = ke(), i = Ae();
	t.exports = a;
	function a(e) {
	...
	var n = C(), r = Ie(), i = Le(), a = Ve(), o = He(), s = Ue(), c = Ce().Graph, l = w();
	t.exports = u;
	function u(e) {
	...
	var n = C(), r = Ee(), i = De(), a = je(), o = w().normalizeRanks, s = Me(), c = w().removeEmptyRanks, l = Ne(), u = Pe(), d = Fe(), f = We(), p = T(), m = w(), h = Ce().Graph;
	t.exports = g;
	function g(e, t) {
	...
	function ae(e) {
		...
		return t.setGraph(n.merge({}, b, _e(r, y), n.pick(r, x))), n.forEach(e.nodes(), function(r) {
			var i = ve(e.node(r));
			t.setNode(r, n.defaults(_e(i, ee), te)), t.setParent(r, e.parent(r));
		}), n.forEach(e.edges(), function(r) {
			var i = ve(e.edge(r));
			t.setEdge(r, n.merge({}, re, _e(i, ne), n.pick(i, ie)));
		}), t;
	}
	function oe(e) {
		var t = e.graph();
...
function Xe(e, t = null) {
	if (!Array.isArray(e)) return "rgba(120, 120, 120, 1)";
	let n = e[0] ?? 120, r = e[1] ?? 120, i = e[2] ?? 120, a = (e[3] ?? 255) / 255;
	return t !== null && (a = t), `rgba(${n}, ${r}, ${i}, ${a})`;
}
function Ze(e, t) {
	...
	if (typeof e == "string") {
		...
		return e.startsWith("rgba") ? e.replace(/,[\s\d.]+\)$/, `, ${t})`) : e;
	}
	return `rgba(255, 255, 255, ${t})`;
}
//#endregion
//#region src/canvas/node-renderer.js
function Qe(e) {
	let t = E.node.border, n = E.node.radius;
	if (e.preset === "node_preset_backdrop") return {
		width: e.metadata?.width || 320,
		height: e.metadata?.height || 220,
		headerHeight: 28,
		attrHeight: 0,
		radius: 8,
		border: 1.5
	};
	if (e.preset === "node_preset_note") return {
		width: e.metadata?.width || 220,
		height: e.metadata?.height || 130,
		headerHeight: 26,
		attrHeight: 0,
		radius: 6,
		border: 1.5
	};
	let r = E.node.width, i = E.node.attrHeight, a = e.attributes.length;
	return {
		width: r,
		height: a > 0 ? 32 + i * a + 6 : 46,
		headerHeight: 32,
		attrHeight: i,
		radius: n,
		border: t
...
function $e(e, t, n, r = null) {
	let { width: i, height: a, headerHeight: o, attrHeight: s, radius: c, border: l } = Qe(t), { x: u, y: d } = t.position, f = t.preset || "node_default", p = E.presets[f] || E.presets.node_default, m = t.metadata?.custom_color || Xe(p.bg), h = n ? Xe(p.borderSel) : t.metadata?.custom_color || Xe(p.border), g = (e) => {
		if (!e) return "rgba(50, 40, 10, 0.85)";
		let t = parseInt(e.substring(1, 3), 16), n = parseInt(e.substring(3, 5), 16), r = parseInt(e.substring(5, 7), 16);
		return (t * 299 + n * 587 + r * 114) / 1e3 >= 128 ? "rgba(50, 40, 10, 0.85)" : "rgba(255, 255, 255, 0.9)";
	};
	if (t.preset === "node_preset_backdrop") {
		e.save(), e.beginPath(), e.roundRect(u, d, i, a, c), e.fillStyle = Ze(t.metadata?.custom_color || "#1e222b", .08), e.fill(), e.save(), e.beginPath(), e.roundRect(u, d, i, a, c), e.clip(), e.fillStyle = Ze(t.metadata?.custom_color || "#1e222b", .25), e.fillRect(u, d, i, o), e.fillStyle = "rgba(255, 255, 255, 0.08)", e.fillRect(u, d + o - 1, i, 1), e.restore(), e.lineWidth = n ? l + .5 : l, e.strokeStyle = n ? h : Ze(t.metadata?.custom_color || "#5a6478", .5), e.stroke(), e.fillStyle = "#ffffff", e.font = "bold 12px sans-serif", e.textAlign = "left", e.textBaseline = "middle", e.fillText(t.name, u + 12, d + o / 2), e.strokeStyle = n ? h : "rgba(255, 255, 255, 0.2)", e.lineWidth = 1.5, e.beginPath(), e.moveTo(u + i - 4, d + a - 12), e.lineTo(u + i - 12, d + a - 4), e.moveTo(u + i - 4, d + a - 8), e.lineTo(u + i - 8, d + a - 4), e.stroke(), e.restore();
		return;
	}
	if (t.preset === "node_preset_note") {
		e.save(), e.shadowColor = "rgba(0, 0, 0, 0.35)", e.shadowBlur = 8, e.shadowOffsetY = 4, e.beginPath(), e.roundRect(u, d, i, a, c), e.fillStyle = m, e.fill(), e.restore(), e.lineWidth = l, e.strokeStyle = h, e.stroke();
		let r = g(t.metadata?.custom_color), s = g(t.metadata?.custom_color).replace("0.85", "1.0").replace("0.9", "1.0");
		e.fillStyle = s, e.font = "bold 11px sans-serif", e.textAlign = "center", e.textBaseline = "middle", e.fillText(t.name, u + i / 2, d + o / 2), e.fillStyle = "rgba(0, 0, 0, 0.08)", e.fillRect(u + 8, d + o, i - 16, 1), e.textAlign = "left", e.textBaseline = "top";
		let f = (t.metadata?.process_details || "Double click to write a note...").split("\n"), p = d + o + 8, _ = u + 8, v = i - 16, y = d + a - 16, b = (t, n, r, i) => {
			e.font = n;
			let a = r - i, o = t.split(/\s+/), s = [], c = "";
			for (let t of o) {
				let n = c ? c + " " + t : t;
				e.measureText(n).width > a && c ? (s.push(c), c = t) : c = n;
			}
			return c && s.push(c), s;
		};
		for (let t = 0; t < f.length; t++) {
			...
			if (e.fillStyle = r, e.font = "10px sans-serif", n.startsWith("#")) {
				let t = n.match(/^(#+)\s*(.*)/);
				if (t) {
					let n = t[1].length, r = t[2], i = Math.max(9, 14 - n), a = `bold ${i}px sans-serif`;
					e.font = a, e.fillStyle = s;
					let o = b(r, a, v, 0);
					for (let t of o) {
						if (p + i + 4 > y) break;
						e.fillText(t, _, p), p += i + 4;
					}
					continue;
				}
			}
			let i = !1, a = 0;
			if ((n.startsWith("- ") || n.startsWith("* ")) && (i = !0, a = 10, n = n.substring(2)), p + 13 > y) break;
			let o = b(n.replace(/\*\*/g, ""), "10px sans-serif", v, a);
			for (let t = 0; t < o.length && !(p + 13 > y); t++) {
				i && t === 0 && (e.beginPath(), e.arc(_ + 3, p + 6, 2, 0, Math.PI * 2), e.fillStyle = r, e.fill());
				let s = i ? a : 0;
				if (t === 0) {
					let t = n.split(/(\*\*.*?\*\*)/g), i = _ + s;
					e.fillStyle = r, t.forEach((t) => {
						if (t.startsWith("**") && t.endsWith("**")) {
							e.font = "bold 9.5px sans-serif";
							let n = t.substring(2, t.length - 2);
							e.fillText(n, i, p), i += e.measureText(n).width;
						} else e.font = "10px sans-serif", e.fillText(t, i, p), i += e.measureText(t).width;
					});
				} else e.font = "10px sans-serif", e.fillStyle = r, e.fillText(o[t], _ + s, p);
				p += 13;
			}
		}
		e.strokeStyle = n ? h : g(t.metadata?.custom_color).replace("0.85", "0.25").replace("0.9", "0.25"), e.lineWidth = 1.5, e.beginPath(), e.moveTo(u + i - 4, d + a - 12), e.lineTo(u + i - 12, d + a - 4), e.moveTo(u + i - 4, d + a - 8), e.lineTo(u + i - 8, d + a - 4), e.stroke();
		return;
	}
	e.save(), e.shadowColor = "rgba(0, 0, 0, 0.45)", e.shadowBlur = 10, e.shadowOffsetY = 5, e.beginPath(), e.roundRect(u, d, i, a, c), e.fillStyle = "#1f242e", e.fill(), e.restore(), e.save(), e.beginPath(), e.roundRect(u, d, i, a, c), e.clip(), e.fillStyle = m, e.fillRect(u, d, i, o), e.fillStyle = "rgba(255, 255, 255, 0.12)", e.fillRect(u, d + o - 1, i, 1), e.restore(), e.lineWidth = l, e.strokeStyle = h, e.stroke(), e.fillStyle = "#ffffff", e.font = `bold ${E.node.fontSize}px ${E.node.font || "sans-serif"}`, e.textAlign = "center", e.textBaseline = "middle", e.fillText(t.name, u + i / 2, d + o / 2), e.textAlign = "left", e.textBaseline = "middle", e.font = `${E.attr.fontSize}px ${E.attr.font || "sans-serif"}`, t.attributes.forEach((n, r) => {
		let a = d + o + r * s + 2, c = E.presets[n.preset] || E.presets.attr_default, f = "transparent";
		t.alternate && r % 2 == 1 && (f = "rgba(255, 255, 255, 0.02)"), f !== "transparent" && (e.fillStyle = f, e.fillRect(u + l, a, i - l * 2, s));
		let p = u + 16, m = a + s / 2;
		if (e.fillStyle = Xe(c.text), e.fillText(n.name, p, m), n.socket) {
			let t = u, n = a + s / 2, r = Xe(c.socket);
			e.beginPath(), e.arc(t, n, 5, 0, Math.PI * 2), e.fillStyle = r, e.fill(), e.strokeStyle = "#11141a", e.lineWidth = 1.5, e.stroke();
		}
		if (n.plug) {
			let t = u + i, n = a + s / 2, r = Xe(c.plug);
			e.beginPath(), e.arc(t, n, 5, 0, Math.PI * 2), e.fillStyle = r, e.fill(), e.strokeStyle = "#11141a", e.lineWidth = 1.5, e.stroke();
		}
	});
}
//#endregion
//#region src/canvas/connection-badge-layout.js
var et = E.badge.size, tt = E.badge.minSeparation, nt = E.badge.nodeCollisionPad, rt = [
	.5,
	.35,
	.65,
	.25,
...
function it(e, t, n, r, i) {
	let a = 1 - i, o = a * a, s = o * a, c = i * i, l = c * i;
	return {
		x: s * e.x + 3 * o * i * t.x + 3 * a * c * n.x + l * r.x,
		y: s * e.y + 3 * o * i * t.y + 3 * a * c * n.y + l * r.y
	};
}
function at(e, t, n, r, i) {
	let a = 1 - i, o = 3 * a * a * (t.x - e.x) + 6 * a * i * (n.x - t.x) + 3 * i * i * (r.x - n.x), s = 3 * a * a * (t.y - e.y) + 6 * a * i * (n.y - t.y) + 3 * i * i * (r.y - n.y), c = Math.hypot(o, s) || 1;
	return {
		x: o / c,
		y: s / c
	};
...
function st(e) {
	...
	e.forEach((e) => {
		let n = `${e.sourceNode}=>${e.targetNode}`;
...
function ct(e, t) {
	return t <= 1 ? .5 : .35 + e / (t - 1) * .3;
}
function lt(e, t) {
	for (let n of t) {
		let { width: t, height: r } = Qe(n), i = n.position.x - nt, a = n.position.x + t + nt, o = n.position.y - nt, s = n.position.y + r + nt;
		if (e.x >= i && e.x <= a && e.y >= o && e.y <= s) return !0;
	}
	return !1;
}
function D(e, t) {
	...
	for (let i of t) {
		let t = Math.hypot(e.x - i.x, e.y - i.y);
		t < n && (n = t, r = i);
	}
	return r;
}
function ut(e, t) {
	...
	let n = Infinity;
	for (let r of t) {
		let t = Math.hypot(e.x - r.x, e.y - r.y);
		t < n && (n = t);
	}
	return n;
}
function dt({ pSource: e, ctrl1: t, ctrl2: n, pTarget: r, seedT: i = .5, obstacleNodes: a = [], placedBadges: o = [] }) {
	let s = /* @__PURE__ */ new Set(), c = [i, ...rt].filter((e) => s.has(e) ? !1 : (s.add(e), !0)).map((i) => {
		let o = it(e, t, n, r, i);
		return {
			t: i,
			pt: o,
	...
	}), l = c.some((e) => e.clearOfNodes) ? c.filter((e) => e.clearOfNodes) : c, u = l[0], d = ut(u.pt, o);
	for (let e of l) {
		let t = ut(e.pt, o);
		t > d && (u = e, d = t);
	}
	if (d >= tt) return u.pt;
	let f = at(e, t, n, r, u.t), p = {
		x: -f.y,
		y: f.x
	}, m = u.pt;
	for (let e = 0; e < 16; e++) {
...
//#endregion
//#region src/canvas/hit-testing.js
function O(e, t) {
	let n = Array.from(t.values()), r = n.filter((e) => e.preset !== "node_preset_backdrop").reverse(), i = n.filter((e) => e.preset === "node_preset_backdrop").reverse();
	for (let t of r) {
		let { width: n, height: r } = Qe(t), { x: i, y: a } = t.position;
		if (e.x >= i && e.x <= i + n && e.y >= a && e.y <= a + r) return t;
	}
	for (let t of i) {
		let { width: n, height: r } = Qe(t), { x: i, y: a } = t.position;
		if (e.x >= i && e.x <= i + n && e.y >= a && e.y <= a + r) return t;
...
function ft(e, t, n) {
	let { width: r, headerHeight: i, attrHeight: a, height: o } = Qe(e), { x: s, y: c } = e.position, l = -1;
	if (n === "socket" ? l = e.attributes.findIndex((e) => e.name === t && e.socket) : n === "plug" && (l = e.attributes.findIndex((e) => e.name === t && e.plug)), l === -1 && (l = e.attributes.findIndex((e) => e.name === t)), l === -1) return {
		x: s + r / 2,
		y: c + o / 2
	};
	let u = c + i + l * a + 2 + a / 2;
...
//#endregion
//#region src/core/graph-topology.js
function pt(e, t) {
	let n = t.nodes.get(e);
	if (!n || n.preset === "node_preset_backdrop") return null;
	let r = null, i = Infinity, a = Qe(n), o = n.position.x + a.width / 2, s = n.position.y + a.height / 2;
	for (let [e, n] of t.nodes.entries()) {
		if (n.preset !== "node_preset_backdrop") continue;
		let t = n.metadata?.width || 320, a = n.metadata?.height || 220;
		if (o >= n.position.x && o <= n.position.x + t && s >= n.position.y && s <= n.position.y + a) {
			let n = t * a;
			n < i && (i = n, r = e);
		}
	}
...
//#endregion
//#region src/core/graph-layout.js
var { _: mt, graphlib: ht } = de(), gt = Ye.default?.graphlib ? Ye.default : Ye.default?.default || Ye.default || {};
gt && !gt.graphlib && (gt.graphlib = typeof window < "u" && window.graphlib ? window.graphlib : ht);
function k(e) {
	for (let [t, n] of e.nodes.entries()) {
		if (n.preset === "node_preset_backdrop" || n.preset === "node_preset_note") continue;
		let r = n.attributes.filter((e) => e.socket), i = n.attributes.filter((e) => e.plug), a = n.attributes.filter((e) => !e.socket && !e.plug), o = (n, r) => {
			let i = 0, a = 0;
			return e.connections.forEach((o) => {
				if (r === "socket" && o.targetNode === t && o.targetAttr === n) {
					let t = e.nodes.get(o.sourceNode);
					t && (i += ft(t, o.sourceAttr, "plug").y, a++);
				}
				if (r === "plug" && o.sourceNode === t && o.sourceAttr === n) {
					let t = e.nodes.get(o.targetNode);
					t && (i += ft(t, o.targetAttr, "socket").y, a++);
				}
			}), a > 0 ? i / a : Infinity;
		};
		r.sort((e, t) => {
			let n = o(e.name, "socket"), r = o(t.name, "socket");
			return n === Infinity && r === Infinity ? 0 : n - r;
		}), i.sort((e, t) => {
			let n = o(e.name, "plug"), r = o(t.name, "plug");
			return n === Infinity && r === Infinity ? 0 : n - r;
		}), n.attributes = [
			...r,
			...i,
...
function _t(e, t, n) {
	let r = E.layout.backdropPadding;
	for (let [i, a] of t.nodes.entries()) {
		if (a.preset !== "node_preset_backdrop") continue;
		let t = e.node(i);
		if (!t) continue;
		let o = n.get(i) || [];
		if (o.length === 0) {
			t.width = a.metadata?.width || 320, t.height = a.metadata?.height || 220;
			continue;
		}
		let s = Infinity, c = Infinity, l = -Infinity, u = -Infinity;
		for (let t of o) {
			let n = e.node(t);
			n && (s = Math.min(s, n.x - n.width / 2), c = Math.min(c, n.y - n.height / 2), l = Math.max(l, n.x + n.width / 2), u = Math.max(u, n.y + n.height / 2));
		}
		let d = s - r.left, f = c - r.top, p = l + r.right, m = u + r.bottom;
		t.width = p - d, t.height = m - f, t.x = (d + p) / 2, t.y = (f + m) / 2;
	}
}
function vt(e, t) {
	let n = E.layout.linkedNoteGap;
	for (let [r, i] of t.nodes.entries()) {
		if (i.preset !== "node_preset_note") continue;
		let a = i.metadata?.linked_process;
		if (!a || !t.nodes.has(a)) continue;
		let o = e.node(a), s = e.node(r);
		!o || !s || (s.x = o.x, s.y = o.y - o.height / 2 - s.height / 2 - n);
	}
}
function yt(e, t) {
	let n = /* @__PURE__ */ new Set(), r = [];
	for (let [e, i] of t.nodes.entries()) i.preset === "node_preset_note" && (n.add(e), i.metadata?.linked_process || r.push(e));
	if (r.length === 0) return;
	let i = Infinity, a = Infinity;
	for (let r of t.nodes.keys()) {
		if (n.has(r)) continue;
		let t = e.node(r);
		t && (i = Math.min(i, t.x - t.width / 2), a = Math.min(a, t.y - t.height / 2));
	}
	isFinite(i) || (i = 0), isFinite(a) || (a = 0);
	let o = E.layout.noteShelfGap, s = E.layout.noteShelfSpacing, c = i;
	r.forEach((t) => {
		let n = e.node(t);
		n && (n.x = c + n.width / 2, n.y = a - o - n.height / 2, c += n.width + s);
	});
}
function bt(e, t, n) {
	function r(e, t) {
		let i = n.get(e);
		if (!i) return t;
		for (let e of i) t.has(e) || (t.add(e), r(e, t));
		return t;
	}
	let i = /* @__PURE__ */ new Map();
	for (let e of t.nodes.keys()) i.set(e, r(e, /* @__PURE__ */ new Set()));
	let a = (e, t) => i.get(e)?.has(t) || i.get(t)?.has(e), o = (t, n, r) => {
		t.dagreNode.x += n, t.dagreNode.y += r;
		for (let a of i.get(t.name) || []) {
			let t = e.node(a);
			t && (t.x += n, t.y += r);
		}
	}, s = [];
	for (let [n, r] of t.nodes.entries()) {
		if (r.preset === "node_preset_note" && !r.metadata?.linked_process) continue;
		let t = e.node(n);
		t && s.push({
			name: n,
			node: r,
	...
	let c = E.layout.overlapPadX, l = E.layout.overlapPadY;
	for (let e = 0; e < 40; e++) {
		let e = !0;
		for (let t = 0; t < s.length; t++) for (let n = t + 1; n < s.length; n++) {
			let r = s[t], i = s[n];
			if (a(r.name, i.name)) continue;
			let u = r.dagreNode.width / 2, d = r.dagreNode.height / 2, f = i.dagreNode.width / 2, p = i.dagreNode.height / 2, m = u + f + c - Math.abs(r.dagreNode.x - i.dagreNode.x), h = d + p + l - Math.abs(r.dagreNode.y - i.dagreNode.y);
			if (m > 0 && h > 0) if (e = !1, m < h) {
				let e = m / 2 + 1, t = r.dagreNode.x <= i.dagreNode.x ? -1 : 1;
				o(r, e * t, 0), o(i, -e * t, 0);
			} else {
				let e = h / 2 + 1, t = r.dagreNode.y <= i.dagreNode.y ? -1 : 1;
				o(r, 0, e * t), o(i, 0, -e * t);
			}
		}
		if (e) break;
...
function xt(e, t = {}) {
	...
	let n = t.rankDir || t.rankdir || "LR", r = t.nodesep === void 0 ? E.layout.fullGraph.nodesep : t.nodesep, i = t.ranksep === void 0 ? E.layout.fullGraph.ranksep : t.ranksep, a = new gt.graphlib.Graph({ compound: !0 });
	a.setGraph({
		rankdir: n,
		nodesep: r,
		ranksep: i,
	...
	for (let [t, n] of e.nodes.entries()) if (n.preset === "node_preset_backdrop") a.setNode(t, {
		label: t,
		isGroup: !0
	});
	else {
		let { width: e, height: r } = Qe(n);
		a.setNode(t, {
			width: e,
			height: r
		});
	...
	for (let t of e.nodes.keys()) {
		let n = pt(t, e);
		n && (a.setParent(t, n), o.has(n) || o.set(n, []), o.get(n).push(t));
	}
	e.connections.forEach((e) => {
		a.setEdge(e.sourceNode, e.targetNode);
	}), gt.layout(a), _t(a, e, o), vt(a, e), yt(a, e), bt(a, e, o);
	let s = {};
	for (let [t, n] of e.nodes.entries()) s[t] = { ...n.position };
	let c = {};
	for (let t of e.nodes.keys()) {
		let n = a.node(t);
		if (n) {
			...
			c[t] = r;
			let i = e.nodes.get(t);
			i && (i.position = r, i.preset === "node_preset_backdrop" && (i.metadata = {
				...i.metadata,
				width: Math.max(160, n.width),
				height: Math.max(100, n.height)
			}));
		}
	}
	if (k(e), !t.animate || e.nodes.size <= 1) {
		e.emit("node:moved", {}), e.emit("graph:layout_completed", {});
		return;
	}
	for (let [t, n] of e.nodes.entries()) {
		let e = s[t];
	...
	let l = null, u = (t) => {
		l ||= t;
		let n = t - l, r = Math.min(1, n / 300), i = r < .5 ? 4 * r * r * r : 1 - (-2 * r + 2) ** 3 / 2;
		for (let t of e.nodes.keys()) {
			let n = s[t], r = c[t];
			if (n && r) {
				let a = n.x + (r.x - n.x) * i, o = n.y + (r.y - n.y) * i, s = e.nodes.get(t);
				s && (s.position = {
					x: a,
					y: o
				});
		...
		e.emit("node:moved", {}), r < 1 ? requestAnimationFrame(u) : e.emit("graph:layout_completed", {});
	};
	requestAnimationFrame(u);
}
//#endregion
//#region src/core/isolation-builder.js
function St(e) {
	return JSON.parse(JSON.stringify(e.metadata || {}));
}
function Ct(e, t, n, r) {
	let i = e.createNode(n, r, t.preset);
	return i && (i.metadata = St(t)), t.attributes.forEach((t) => e.createAttribute(n, t)), i;
}
function wt(e, t, n, r) {
	if (!n || e.nodes.has(n)) return;
	let i = t.nodes.get(n);
	if (!i || (Ct(e, i, n, {
		x: 200,
		y: 40
	}), !r)) return;
	let a = t.getIsolatedData(n);
	a && (Object.entries(a.inputs).forEach(([r, i]) => {
		i.connections.forEach(([i, a]) => {
			if (!e.nodes.has(i)) {
				let n = t.nodes.get(i);
				n && Ct(e, n, i, {
					x: 50,
			...
			e.createConnection(i, a, n, r);
		});
	}), Object.entries(a.outputs).forEach(([r, i]) => {
		i.connections.forEach(([i, a]) => {
			if (!e.nodes.has(i)) {
				let n = t.nodes.get(i);
				n && Ct(e, n, i, {
...
function Tt(e, t) {
	...
	if (!n) return null;
	let r = new pe();
	if (n.preset === "node_preset_backdrop") {
		let i = [];
		for (let [n, r] of e.nodes.entries()) n !== t && pt(n, e) === t && i.push(r);
		let a = r.createNode(t, { ...n.position }, n.preset);
		a && (a.metadata = St(n));
		let o = new Set(i.map((e) => e.name));
		for (let e of i) Ct(r, e, e.name, { ...e.position });
		for (let t of e.connections) o.has(t.sourceNode) && o.has(t.targetNode) && r.createConnection(t.sourceNode, t.sourceAttr, t.targetNode, t.targetAttr);
		return r;
	}
	let i = e.getIsolatedData(t);
	if (!i) return null;
	if (Ct(r, n, t, {
		x: 200,
		y: 200
	}), Object.entries(i.inputs).forEach(([n, i]) => {
		i.connections.forEach(([i, a]) => {
			if (!r.nodes.has(i)) {
				let t = e.nodes.get(i);
				t && Ct(r, t, i, {
			...
			r.createConnection(i, a, t, n);
		});
	}), Object.entries(i.outputs).forEach(([n, i]) => {
		i.connections.forEach(([i, a]) => {
			if (!r.nodes.has(i)) {
				let t = e.nodes.get(i);
				t && Ct(r, t, i, {
			...
			r.createConnection(t, n, i, a);
		});
	}), n.preset === "node_preset_note") wt(r, e, n.metadata?.linked_process, !0);
	else for (let [n, i] of e.nodes.entries()) i.preset === "node_preset_note" && i.metadata?.linked_process === t && wt(r, e, n, !1);
	return xt(r, {
		animate: !1,
		nodesep: E.layout.isolation.nodesep,
		ranksep: E.layout.isolation.ranksep
	}), r;
}
//#endregion
//#region src/canvas/grid-renderer.js
function Et(e, t, n, r, i) {
	let a = E.grid.size;
	e.strokeStyle = Xe(E.grid.color), e.lineWidth = 1 / i;
	let o = -r.x / i, s = (t - r.x) / i, c = -r.y / i, l = (n - r.y) / i, u = Math.floor(o / a) * a, d = s + a, f = Math.floor(c / a) * a, p = l + a;
	e.beginPath();
	for (let t = u; t < d; t += a) e.moveTo(t, c), e.lineTo(t, l);
	for (let t = f; t < p; t += a) e.moveTo(o, t), e.lineTo(s, t);
	e.stroke();
}
//#endregion
//#region src/canvas/connection-renderer.js
function Dt(e, t, n, r = !0) {
	let { ctrl1: i, ctrl2: a } = ot(t, n);
	return e.save(), e.beginPath(), e.moveTo(t.x, t.y), e.bezierCurveTo(i.x, i.y, a.x, a.y, n.x, n.y), e.strokeStyle = Xe(E.connection.color, r ? 1 : .25), e.lineWidth = E.connection.width, e.stroke(), e.restore(), {
		ctrl1: i,
		ctrl2: a
	};
}
function Ot(e, t, n, r, i, a, { graph: o = null, seedT: s = .5, placedBadges: c = [], active: l = !0 } = {}) {
	if (!a) return null;
	let u;
	u = o && o.nodes ? dt({
		pSource: t,
		...
		pTarget: i,
		seedT: s,
		obstacleNodes: Array.from(o.nodes.values()).filter((e) => e.preset !== "node_preset_backdrop"),
		placedBadges: c
	}) : it(t, n, r, i, s);
	let d = xe.getImage(a);
	return d && d.complete ? (e.save(), e.beginPath(), e.arc(u.x, u.y, et / 2 - 4, 0, Math.PI * 2), e.fillStyle = "#0f172a", e.fill(), e.drawImage(d, u.x - et / 2, u.y - et / 2, et, et), e.restore()) : (e.save(), e.beginPath(), e.arc(u.x, u.y, 16, 0, Math.PI * 2), e.fillStyle = "#2d3748", e.fill(), e.strokeStyle = Xe(E.connection.color, l ? 1 : .25), e.lineWidth = 1, e.stroke(), e.fillStyle = "#ffffff", e.font = "bold 8px sans-serif", e.textAlign = "center", e.textBaseline = "middle", e.fillText(a.toUpperCase().substring(0, 4), u.x, u.y), e.restore()), u;
}
//#endregion
//#region src/embed/viewer-canvas.js
var kt = class {
	constructor(e, t, n) {
		this.canvas = e, this.ctx = e.getContext("2d"), this.graph = t, this.onNodeClick = n, this.pan = {
			x: 0,
			y: 0
		}, this.zoom = 1, this.selectedNodeName = null, this.isPanning = !1, this.panStart = {
			x: 0,
			y: 0
		}, this.isDraggingNode = !1, this.dragNode = null, this.dragStartWorld = {
			x: 0,
			y: 0
		}, this.dragStartNodePos = {
			x: 0,
			y: 0
		}, this.childNodeStarts = [], this.hasDragged = !1, this.initEvents();
	}
	setSelectedNode(e) {
		this.selectedNodeName = e || null, this.render();
	}
	initEvents() {
		this.canvas.addEventListener("mousedown", this.handleMouseDown.bind(this)), this.canvas.addEventListener("mousemove", this.handleMouseMove.bind(this)), this.canvas.addEventListener("mouseup", this.handleMouseUp.bind(this)), this.canvas.addEventListener("mouseleave", this.handleMouseUp.bind(this)), this.canvas.addEventListener("wheel", this.handleWheel.bind(this)), this.touchState = {
			...
			pinchStartZoom: null,
			pinchMidpoint: null
		}, this.canvas.addEventListener("touchstart", this.handleTouchStart.bind(this), { passive: !1 }), this.canvas.addEventListener("touchmove", this.handleTouchMove.bind(this), { passive: !1 }), this.canvas.addEventListener("touchend", this.handleTouchEnd.bind(this), { passive: !1 });
	}
	handleTouchStart(e) {
		let t = this.canvas.getBoundingClientRect();
		if (e.touches.length === 1) {
			e.preventDefault();
			let n = e.touches[0], r = n.clientX - t.left, i = n.clientY - t.top, a = this.screenToWorld(r, i), o = O(a, this.graph.nodes);
			if (o) if (this.isDraggingNode = !0, this.dragNode = o, this.dragStartWorld = { ...a }, this.dragStartNodePos = {
				x: o.position.x,
				y: o.position.y
			}, this.hasDragged = !1, this.setSelectedNode(o.name), this.onNodeClick(o.name), o.preset === "node_preset_backdrop") {
				let { width: e, height: t } = Qe(o), n = o.position.x, r = o.position.y;
				this.childNodeStarts = [];
				for (let i of this.graph.nodes.values()) {
					if (i.name === o.name || i.preset === "node_preset_backdrop") continue;
					let { width: a, height: s } = Qe(i), c = i.position.x, l = i.position.y;
					c >= n && c + a <= n + e && l >= r && l + s <= r + t && this.childNodeStarts.push({
						node: i,
						startX: c,
						startY: l
					});
				}
			} else this.childNodeStarts = [];
			else this.isPanning = !0, this.panStart = {
				x: n.clientX - this.pan.x,
				y: n.clientY - this.pan.y
			};
			this.touchState.startPos = {
				x: r,
				y: i
			}, this.touchState.hasMoved = !1, this.touchState.pinchStartDist = null;
		} else if (e.touches.length === 2) {
			e.preventDefault();
			let n = e.touches[0], r = e.touches[1];
			this.touchState.pinchStartDist = Math.hypot(r.clientX - n.clientX, r.clientY - n.clientY), this.touchState.pinchStartZoom = this.zoom, this.touchState.pinchMidpoint = {
				x: (n.clientX + r.clientX) / 2 - t.left,
				y: (n.clientY + r.clientY) / 2 - t.top
			}, this.isPanning = !1, this.isDraggingNode = !1;
		}
	}
	handleTouchMove(e) {
		let t = this.canvas.getBoundingClientRect();
		if (e.touches.length === 1) {
			let n = e.touches[0], r = n.clientX - t.left, i = n.clientY - t.top, a = this.screenToWorld(r, i);
			if (this.isDraggingNode && this.dragNode) {
				e.preventDefault();
				let t = a.x - this.dragStartWorld.x, n = a.y - this.dragStartWorld.y;
				if (Math.hypot(t, n) > 2 && (this.touchState.hasMoved = !0, this.hasDragged = !0), this.dragNode.position.x = this.dragStartNodePos.x + t, this.dragNode.position.y = this.dragStartNodePos.y + n, this.childNodeStarts.length > 0) for (let e of this.childNodeStarts) e.node.position.x = e.startX + t, e.node.position.y = e.startY + n;
				this.render();
				return;
			}
			if (this.isPanning) {
				e.preventDefault();
				let t = this.touchState.startPos || {
					x: r,
					y: i
				};
				Math.hypot(r - t.x, i - t.y) > 5 && (this.touchState.hasMoved = !0), this.pan = {
					x: n.clientX - this.panStart.x,
					y: n.clientY - this.panStart.y
				}, this.render();
			}
		} else if (e.touches.length === 2 && this.touchState.pinchStartDist !== null) {
			e.preventDefault();
			let n = e.touches[0], r = e.touches[1], i = Math.hypot(r.clientX - n.clientX, r.clientY - n.clientY) / this.touchState.pinchStartDist, a = Math.max(.1, Math.min(3, this.touchState.pinchStartZoom * i)), o = {
				x: (n.clientX + r.clientX) / 2 - t.left,
				y: (n.clientY + r.clientY) / 2 - t.top
			}, s = this.touchState.pinchMidpoint || o, c = (s.x - this.pan.x) / this.zoom, l = (s.y - this.pan.y) / this.zoom, u = o.x - s.x, d = o.y - s.y;
			this.zoom = a, this.pan = {
				x: o.x - c * a + u,
				y: o.y - l * a + d
			}, this.touchState.pinchMidpoint = o, this.render();
		}
	}
	handleTouchEnd(e) {
		if (e.touches.length === 0) {
			if (this.isDraggingNode) this.isDraggingNode = !1, this.dragNode = null, this.childNodeStarts = [];
			else if (this.isPanning && !this.touchState.hasMoved && this.touchState.startPos) {
				let e = O(this.screenToWorld(this.touchState.startPos.x, this.touchState.startPos.y), this.graph.nodes);
				e ? (this.setSelectedNode(e.name), this.onNodeClick(e.name)) : (this.setSelectedNode(null), this.onNodeClick(null));
			}
			this.isPanning = !1, this.touchState.startPos = null, this.touchState.hasMoved = !1, this.touchState.pinchStartDist = null, this.touchState.pinchStartZoom = null, this.touchState.pinchMidpoint = null;
		} else e.touches.length === 1 && (this.touchState.pinchStartDist = null);
	}
	screenToWorld(e, t) {
		return {
			x: (e - this.pan.x) / this.zoom,
			y: (t - this.pan.y) / this.zoom
		};
	}
	handleMouseDown(e) {
		let t = this.canvas.getBoundingClientRect(), n = e.clientX - t.left, r = e.clientY - t.top, i = this.screenToWorld(n, r), a = O(i, this.graph.nodes);
		if (a) if (this.isDraggingNode = !0, this.dragNode = a, this.dragStartWorld = { ...i }, this.dragStartNodePos = {
			x: a.position.x,
			y: a.position.y
		}, this.hasDragged = !1, this.setSelectedNode(a.name), this.onNodeClick(a.name), a.preset === "node_preset_backdrop") {
			let { width: e, height: t } = Qe(a), n = a.position.x, r = a.position.y;
			this.childNodeStarts = [];
			for (let i of this.graph.nodes.values()) {
				if (i.name === a.name || i.preset === "node_preset_backdrop") continue;
				let { width: o, height: s } = Qe(i), c = i.position.x, l = i.position.y;
				c >= n && c + o <= n + e && l >= r && l + s <= r + t && this.childNodeStarts.push({
					node: i,
					startX: c,
					startY: l
				});
	...
	handleMouseMove(e) {
		let t = this.canvas.getBoundingClientRect(), n = e.clientX - t.left, r = e.clientY - t.top, i = this.screenToWorld(n, r);
		if (this.isDraggingNode && this.dragNode) {
			let e = i.x - this.dragStartWorld.x, t = i.y - this.dragStartWorld.y;
			if (Math.hypot(e, t) > 2 && (this.hasDragged = !0), this.dragNode.position.x = this.dragStartNodePos.x + e, this.dragNode.position.y = this.dragStartNodePos.y + t, this.childNodeStarts.length > 0) for (let n of this.childNodeStarts) n.node.position.x = n.startX + e, n.node.position.y = n.startY + t;
			this.render();
			return;
		}
		this.isPanning && (this.pan = {
	...
	handleMouseUp(e) {
		if (this.isDraggingNode) {
			this.isDraggingNode = !1, this.dragNode = null, this.childNodeStarts = [];
			return;
		}
		if (this.isPanning) {
			this.isPanning = !1;
			let t = this.canvas.getBoundingClientRect(), n = e.clientX - t.left, r = e.clientY - t.top;
			O(this.screenToWorld(n, r), this.graph.nodes) || (this.setSelectedNode(null), this.onNodeClick(null));
		}
	}
	handleWheel(e) {
		e.preventDefault();
		let t = this.canvas.getBoundingClientRect(), n = e.clientX - t.left, r = e.clientY - t.top, i = this.screenToWorld(n, r), a = 1.15, o = e.deltaY < 0 ? this.zoom * a : this.zoom / a, s = Math.max(.1, Math.min(3, o));
		this.zoom = s, this.pan = {
			x: n - i.x * s,
			y: r - i.y * s
		}, this.render();
	}
	fitToView() {
		...
		for (let i of this.graph.nodes.values()) {
			let { width: a, height: o } = Qe(i), { x: s, y: c } = i.position;
			s < e && (e = s), s + a > t && (t = s + a), c < n && (n = c), c + o > r && (r = c + o);
		}
		let i = t - e + 120, a = r - n + 120, o = this.canvas.width / i, s = this.canvas.height / a, c = Math.max(.15, Math.min(1.5, Math.min(o, s))), l = e + (t - e) / 2, u = n + (r - n) / 2;
		this.zoom = c, this.pan = {
			x: this.canvas.width / 2 - l * c,
			y: this.canvas.height / 2 - u * c
		}, this.render();
	}
	focusNode(e) {
		let t = this.graph.nodes.get(e);
		if (!t) return;
		let n = 1.15;
		this.zoom = n;
		let { width: r, height: i } = Qe(t), a = t.position.x + r / 2, o = t.position.y + i / 2;
		this.pan = {
			x: this.canvas.width / 2 - a * n,
			y: this.canvas.height / 2 - o * n
		}, this.setSelectedNode(e);
	}
	render() {
		let e = this.ctx;
		e.clearRect(0, 0, this.canvas.width, this.canvas.height), e.save(), e.translate(this.pan.x, this.pan.y), e.scale(this.zoom, this.zoom), Et(e, this.canvas.width, this.canvas.height, this.pan, this.zoom), this.graph.nodes.forEach((t) => {
			t.preset === "node_preset_backdrop" && $e(e, t, this.selectedNodeName === t.name);
		});
		let t = [];
		this.graph.connections.forEach((n) => {
			let r = this.graph.nodes.get(n.sourceNode), i = this.graph.nodes.get(n.targetNode);
			if (!r || !i) return;
			let a = ft(r, n.sourceAttr, "plug"), o = ft(i, n.targetAttr, "socket"), s = r.attributes.find((e) => e.name === n.sourceAttr && e.plug) || r.attributes.find((e) => e.name === n.sourceAttr), { ctrl1: c, ctrl2: l } = Dt(e, a, o, !0);
			t.push({
				conn: n,
				pSource: a,
				pTarget: o,
				ctrl1: c,
				ctrl2: l,
				dataTypeCode: s?.dataType
			});
		});
		let n = st(this.graph.connections), r = [];
		t.forEach(({ conn: t, pSource: i, pTarget: a, ctrl1: o, ctrl2: s, dataTypeCode: c }) => {
			let { index: l, count: u } = n.get(t) || {
				index: 0,
				count: 1
			}, d = Ot(e, i, o, s, a, c, {
				graph: this.graph,
...
var Pt = ((e = "") => {
	...
	fencesBeginRegex: Nt((e) => RegExp(`^ {0,${e}}(?:\`\`\`|~~~)`)),
	headingBeginRegex: Nt((e) => RegExp(`^ {0,${e}}#`)),
	htmlBeginRegex: Nt((e) => RegExp(`^ {0,${e}}<(?:[a-z].*>|!--)`, "i")),
	blockquoteBeginRegex: Nt((e) => RegExp(`^ {0,${e}}>`))
	...
	table: A,
	text: Wt
}, Qt = j("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr", Rt).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("blockquote", " {0,3}>").replace("code", "(?: {4}| {0,3}	)[^\\n]").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", I).getRegex(), L = {
	...Zt,
	lheading: Ut,
	table: Qt,
	paragraph: j(N).replace("hr", Rt).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("table", Qt).replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)])[ \\t]+[^ \\t\\n]").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", I).getRegex()
}, $t = {
	...Zt,
	...
	...An,
	link: j(/^!?\[(label)\]\((.*?)\)/).replace("label", wn).getRegex(),
	reflink: j(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", wn).getRegex()
}, Mn = {
	...An,
	...
	delLDelim: vn,
	delRDelim: yn,
	url: j(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol", kn).replace("email", /[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),
	_backpedal: /(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,
	del: /^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,
	text: j(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol", kn).getRegex()
}, Nn = {
	...Mn,
	br: j(nn).replace("{2,}", "*").getRegex(),
	text: j(Mn.text).replace("\\b_", "\\b_| {2,}\\n").replace(/\{2,\}/g, "*").getRegex()
}, Pn = {
	normal: Zt,
	gfm: L,
	pedantic: $t
...
function Rn(e, t) {
	if (t) {
		if (M.escapeTest.test(e)) return e.replace(M.escapeReplace, Ln);
	} else if (M.escapeTestNoEncode.test(e)) return e.replace(M.escapeReplaceNoEncode, Ln);
	return e;
}
function zn(e) {
	try {
...
var qn = class {
	...
	code(e) {
		...
		if (t) {
			let e = this.options.pedantic ? t[0] : Hn(t[0]);
			return {
				type: "code",
				raw: e,
	...
	fences(e) {
		...
		if (t) {
			let e = t[0], n = Kn(e, t[3] || "", this.rules);
			return {
				type: "code",
				raw: e,
...
${c}` : c;
	...
	table(e) {
		...
		let n = Bn(t[1]), r = t[2].replace(this.rules.other.tableAlignChars, "").split("|"), i = t[3]?.trim() ? t[3].replace(this.rules.other.tableRowBlankLine, "").split("\n") : [], a = {
			type: "table",
			raw: Vn(t[0], "\n"),
			header: [],
			align: [],
		...
		if (n.length === r.length) {
			...
			for (let e of i) a.rows.push(Bn(e, a.header.length).map((e, t) => ({
				text: e,
				tokens: this.lexer.inline(e),
				header: !1,
				align: a.align[t]
	...
	tokenizer;
	constructor(e) {
		this.tokens = [], this.tokens.links = Object.create(null), this.options = e || jt, this.options.tokenizer = this.options.tokenizer || new qn(), this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options, this.tokenizer.lexer = this, this.inlineQueue = [], this.state = {
			inLink: !1,
			inRawBlock: !1,
			top: !0
		};
		...
		this.options.pedantic ? (t.block = Pn.pedantic, t.inline = Fn.pedantic) : this.options.gfm && (t.block = Pn.gfm, this.options.breaks ? t.inline = Fn.breaks : t.inline = Fn.gfm), this.tokenizer.rules = t;
	}
	static get rules() {
		return {
			block: Pn,
...
`;
	...
	link({ href: e, title: t, tokens: n }) {
		let r = this.parser.parseInline(n), i = zn(e);
		if (i === null) return r;
		e = i;
		let a = "<a href=\"" + e + "\"";
		return t && (a += " title=\"" + Rn(t) + "\""), a += ">" + r + "</a>", a;
	}
	image({ href: e, title: t, text: n, tokens: r }) {
		r && (n = this.parser.parseInline(r, this.parser.textRenderer));
		let i = zn(e);
		if (i === null) return Rn(n);
		e = i;
		let a = `<img src="${e}" alt="${Rn(n)}"`;
		return t && (a += ` title="${Rn(t)}"`), a += ">", a;
	}
	text(e) {
		return "tokens" in e && e.tokens ? this.parser.parseInline(e.tokens) : "escaped" in e && e.escaped ? e.text : Rn(e.text);
	}
}, Xn = class {
	strong({ text: e }) {
		return e;
	...
	textRenderer;
	constructor(e) {
		this.options = e || jt, this.options.renderer = this.options.renderer || new Yn(), this.renderer = this.options.renderer, this.renderer.options = this.options, this.renderer.parser = this, this.textRenderer = new Xn();
	}
	static parse(t, n) {
	...
	provideLexer(e = this.block) {
		return e ? Jn.lex : Jn.lexInline;
	}
	provideParser(e = this.block) {
		return e ? Zn.parse : Zn.parseInline;
	}
}, $n = new class {
	defaults = At();
	...
	use(...e) {
		...
		return e.forEach((e) => {
			...
			if (e.tokenizer) {
				let t = this.defaults.tokenizer || new qn(this.defaults);
			...
			if (e.hooks) {
				let t = this.defaults.hooks || new Qn();
				for (let n in e.hooks) {
					if (!(n in t)) throw Error(`hook '${n}' does not exist`);
					if (["options", "block"].includes(n)) continue;
					let r = n, i = e.hooks[r], a = t[r];
					Qn.passThroughHooks.has(n) ? t[r] = (e) => {
						if (this.defaults.async && Qn.passThroughHooksRespectAsync.has(n)) return (async () => {
	...
	lexer(e, t) {
		return Jn.lex(e, t ?? this.defaults);
	}
	parser(e, t) {
		return Zn.parse(e, t ?? this.defaults);
	}
	parseMarkdown(e) {
		return (t, n) => {
			let r = { ...n }, i = {
			...
			if (i.hooks && (i.hooks.options = i, i.hooks.block = e), i.async) return (async () => {
				let n = i.hooks ? await i.hooks.preprocess(t) : t, r = await (i.hooks ? await i.hooks.provideLexer(e) : e ? Jn.lex : Jn.lexInline)(n, i), a = i.hooks ? await i.hooks.processAllTokens(r) : r;
				i.walkTokens && await Promise.all(this.walkTokens(a, i.walkTokens));
				let o = await (i.hooks ? await i.hooks.provideParser(e) : e ? Zn.parse : Zn.parseInline)(a, i);
				return i.hooks ? await i.hooks.postprocess(o) : o;
			})().catch(a);
			try {
				i.hooks && (t = i.hooks.preprocess(t));
				let n = (i.hooks ? i.hooks.provideLexer(e) : e ? Jn.lex : Jn.lexInline)(t, i);
				i.hooks && (n = i.hooks.processAllTokens(n)), i.walkTokens && this.walkTokens(n, i.walkTokens);
				let r = (i.hooks ? i.hooks.provideParser(e) : e ? Zn.parse : Zn.parseInline)(n, i);
	...
	onError(e, t) {
		return (n) => {
			if (n.message += "\nPlease report this to https://github.com/markedjs/marked.", e) {
				let e = "<p>An error occurred:</p><pre>" + Rn(n.message + "", !0) + "</pre>";
...
B.options = B.setOptions = function(e) {
	return $n.setOptions(e), B.defaults = $n.defaults, Mt(B.defaults), B;
}, B.getDefaults = At, B.defaults = jt, B.use = function(...e) {
	return $n.use(...e), B.defaults = $n.defaults, Mt(B.defaults), B;
}, B.walkTokens = function(e, t) {
	return $n.walkTokens(e, t);
}, B.parseInline = $n.parseInline, B.Parser = Zn, B.parser = Zn.parse, B.Renderer = Yn, B.TextRenderer = Xn, B.Lexer = Jn, B.lexer = Jn.lex, B.Tokenizer = qn, B.Hooks = Qn, B.parse = B, B.options, B.setOptions, B.use, B.walkTokens, B.parseInline, Zn.parse, Jn.lex;
//#endregion
...
var tr = class e {
	...
	initShadow() {
		...
		e.textContent = er, this.shadow.appendChild(e);
	}
	initDom() {
		...
		if (e.className = "plumber-btn", e.innerHTML = "🔍 Fit View", e.onclick = () => this.viewerCanvas.fitToView(), this.toolbar.appendChild(e), this.options.isolation) {
			let e = document.createElement("button");
			e.className = "plumber-btn", e.innerHTML = "👁️ Isolate Node", e.onclick = () => {
	...
	initCanvas() {
		this.viewerCanvas = new kt(this.canvasEl, this.graph, (e) => {
			this.handleNodeClick(e);
		});
	}
	resize() {
		let e = this.canvasContainer.clientWidth, t = this.canvasContainer.clientHeight;
		this.canvasEl.width = e, this.canvasEl.height = t, this.viewerCanvas && this.viewerCanvas.render();
	}
	handleNodeClick(e) {
		if (this.selectedNodeName = e || null, this.viewerCanvas && this.viewerCanvas.setSelectedNode(this.selectedNodeName), this.emit("node:click", e), this.options.documentation && this.sidebar) {
			let t = this.graph.nodes.get(e), n = this.sidebar.querySelector(".plumber-docs-content");
			if (t && n) {
				let e = t.metadata?.process_details || "*No description provided.*", r = t.attributes.filter((e) => e.socket).map((e) => `<li>${e.name} (<code>${e.dataType}</code>)</li>`).join(""), i = t.attributes.filter((e) => e.plug).map((e) => `<li>${e.name} (<code>${e.dataType}</code>)</li>`).join("");
				n.innerHTML = `
	...
	loadGraph(e) {
		Se(e, this.graph) && (this.options.autoLayout && xt(this.graph, { animate: !1 }), this.resize(), this.options.selectNode && this.selectNode(this.options.selectNode), this.options.fitOnLoad && setTimeout(() => this.viewerCanvas.fitToView(), 50), this.emit("graph:loaded", e));
	}
	selectNode(e) {
		if (e) this.handleNodeClick(e);
		else if (this.selectedNodeName = null, this.viewerCanvas && this.viewerCanvas.setSelectedNode(null), this.options.documentation && this.sidebar) {
			let e = this.sidebar.querySelector(".plumber-docs-content");
			e && (e.innerHTML = "<div class=\"plumber-docs-empty\">Click a node to inspect its pipeline documentation.</div>");
		}
	}
	async loadFromUrl(e) {
		try {
			...
			console.error(`Failed to fetch graph from URL: ${e}`, t);
		}
	}
	focusNode(e) {
		if (this.viewerCanvas) {
			if (e) this.viewerCanvas.focusNode(e), this.handleNodeClick(e);
			else if (this.selectedNodeName = null, this.viewerCanvas.fitToView(), this.options.documentation && this.sidebar) {
				let e = this.sidebar.querySelector(".plumber-docs-content");
				e && (e.innerHTML = "<div class=\"plumber-docs-empty\">Click a node to inspect its pipeline documentation.</div>");
			}
		}
	...
	showIsolation(e) {
		let t = this.root.querySelector(".plumber-iso-overlay");
		if (t && t.remove(), !e) {
			this.emit("isolation:close", null);
			return;
		}
		if (!this.graph.nodes.get(e)) {
			console.warn(`Cannot isolate unknown node: ${e}`);
			return;
		}
		let n = document.createElement("div");
		n.className = "plumber-iso-overlay", n.innerHTML = `
    ...
    `, this.root.appendChild(n);
		let r = n.querySelector(".plumber-close-iso");
		r.onclick = () => {
			n.remove(), this.emit("isolation:close", null);
		};
		let i = n.querySelector(".plumber-canvas"), a = n.querySelector(".plumber-iso-canvas-container");
		i.width = a.clientWidth, i.height = a.clientHeight;
		let o = Tt(this.graph, e);
		o && new kt(i, o, () => {}).fitToView(), this.emit("isolation:open", e);
	}
	toggleFullScreen(e) {
	...
	selectNode(e) {
		this.viewer && this.viewer.selectNode(e);
	}
	focusNode(e) {
		this.viewer && this.viewer.focusNode(e);
	}
	showIsolation(e) {
	...
	loadFromUrl(e) {
		this.viewer && this.viewer.loadFromUrl(e);
	}
};
typeof window < "u" && (window.PlumberViewer = tr, typeof customElements < "u" && !customElements.get("plumber-viewer") && customElements.define("plumber-viewer", nr));
//#endregion
export { tr as PlumberViewer, nr as PlumberViewerElement };
